...
const config = ConnectorConfig.create({
    ...
    // auth: { itaubank: { apiKey: { value: 'YOUR_API_KEY' } } },
});
```
...
**Examples:** [Python](../../examples/itaubank/itaubank.py) · [TypeScript](../../examples/itaubank/itaubank.ts#L22) · [Kotlin](../../examples/itaubank/itaubank.kt) · [Rust](../../examples/itaubank/itaubank.rs)
