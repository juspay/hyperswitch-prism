...
Source: data/field_probe/paylater.json
Regenerate: python3 scripts/generators/docs/generate.py paylater
-->
...
config = sdk_config_pb2.ConnectorConfig(
    ...
    connector_config=payment_pb2.ConnectorSpecificConfig(
        paylater=payment_pb2.PaylaterConfig(
...
let config = ConnectorConfig {
    connector_config: Some(ConnectorSpecificConfig {
            config: Some(connector_specific_config::Config::Paylater(PaylaterConfig {
...
**Examples:** [Python](../../examples/paylater/paylater.py) · [TypeScript](../../examples/paylater/paylater.ts#L34) · [Kotlin](../../examples/paylater/paylater.kt#L37) · [Rust](../../examples/paylater/paylater.rs)
