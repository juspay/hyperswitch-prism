...
**Use this for:** Returning funds to customers after successful payment

**Flows used:** authorize, refund
...
| 2 | PaymentService.Refund | Initiate a refund to customer's payment method. Returns funds for returns, cancellations, or service adjustments after original payment. | `PaymentServiceRefundRequest` |
