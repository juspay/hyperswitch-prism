...
# 1. Reconstruct the complex PazeDecryptedData block manually in the script
start_marker = 'impl ForeignTryFrom<grpc_api_types::payments::PazeDecryptedData>'
end_marker = 'impl ForeignTryFrom<(Secret<String>, &\'static str)> for SecretSerdeValue {'
...
# 2. Reconstruct SecretSerdeValue block
start_marker_2 = 'impl ForeignTryFrom<(Secret<String>, &\'static str)> for SecretSerdeValue {'
end_marker_2 = '// For decoding connector feature data'
...
# Re-assemble content
content = content[:start_idx] + new_paze_block + content[end_idx:start_idx_2] + new_secret_block + content[end_idx_2:]
