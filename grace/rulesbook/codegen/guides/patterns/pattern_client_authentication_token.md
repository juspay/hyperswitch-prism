...
| 1.1.1 | 2026-04-20 | `60540470c` | Sibling pattern files renamed by PR #855 rollout in the rulesbook: `pattern_CreateAccessToken_flow.md` → `pattern_server_authentication_token.md`, `pattern_session_token.md` → `pattern_server_session_authentication_token.md`. Cross-reference links, retired-identifier table cross-refs, and Common Errors / Gotchas prose updated to point at the new filenames. Retired-identifier names themselves preserved verbatim so readers can still recognize pre-rename code. |
