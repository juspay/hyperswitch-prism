Source: https://docs.fiserv.dev/public/reference/submitsecondarytransaction
...
post 
https://prod.emea.api.fiservapps.com/sandbox/ipp/payments-gateway/v2/payments/{transaction-id}

Use this to perform a  subsequent transaction, e.g. void, postAuth or return.
...
PostAuthTransactionVoidTransactionVoidPreAuthTransactionsReturnTransactionPreAuthSecondaryTransaction
