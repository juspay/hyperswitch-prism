...
public class HyperswitchResponses extends TableImpl<HyperswitchResponsesRecord> {
     ...
     */
    public final TableField<HyperswitchResponsesRecord, ULong> RECORD_ID = createField(DSL.name("record_id"), SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.kb_account_id</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> KB_ACCOUNT_ID = createField(DSL.name("kb_account_id"), SQLDataType.CHAR(36).nullable(false), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.kb_payment_id</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> KB_PAYMENT_ID = createField(DSL.name("kb_payment_id"), SQLDataType.CHAR(36).nullable(false), this, "");

    /**
     * The column
     * <code>killbill.hyperswitch_responses.kb_payment_transaction_id</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> KB_PAYMENT_TRANSACTION_ID = createField(DSL.name("kb_payment_transaction_id"), SQLDataType.CHAR(36).nullable(false), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.transaction_type</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> TRANSACTION_TYPE = createField(DSL.name("transaction_type"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.amount</code>.
     */
    public final TableField<HyperswitchResponsesRecord, BigDecimal> AMOUNT = createField(DSL.name("amount"), SQLDataType.DECIMAL(15, 9).defaultValue(DSL.inline("NULL", SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.currency</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> CURRENCY = createField(DSL.name("currency"), SQLDataType.CHAR(3).defaultValue(DSL.inline("NULL", SQLDataType.CHAR)), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.hyperswitch_id</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> HYPERSWITCH_ID = createField(DSL.name("hyperswitch_id"), SQLDataType.VARCHAR(255).defaultValue(DSL.inline("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.additional_data</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> ADDITIONAL_DATA = createField(DSL.name("additional_data"), SQLDataType.CLOB.defaultValue(DSL.inline("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.created_date</code>.
     */
    public final TableField<HyperswitchResponsesRecord, LocalDateTime> CREATED_DATE = createField(DSL.name("created_date"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");

    /**
     * The column <code>killbill.hyperswitch_responses.kb_tenant_id</code>.
     */
    public final TableField<HyperswitchResponsesRecord, String> KB_TENANT_ID = createField(DSL.name("kb_tenant_id"), SQLDataType.CHAR(36).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>killbill.hyperswitch_responses</code> table
     * reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.HYPERSWITCH_RESPONSES_HYPERSWITCH_RESPONSES_HYPERSWITCH_ID, Indexes.HYPERSWITCH_RESPONSES_HYPERSWITCH_RESPONSES_KB_PAYMENT_ID, Indexes.HYPERSWITCH_RESPONSES_HYPERSWITCH_RESPONSES_KB_PAYMENT_TRANSACTION_ID);
    }
    ...
    @Override
    public List<UniqueKey<HyperswitchResponsesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_HYPERSWITCH_RESPONSES_RECORD_ID);
    }
