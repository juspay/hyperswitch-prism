...
impl ForeignTryFrom<grpc_api_types::payments::Connector> for ConnectorEnum {
    ...
    fn foreign_try_from(
        ...
        match connector {
            ...
            grpc_api_types::payments::Connector::Paylater => Ok(Self::Paylater),
    ...
    fn from(pm_data: PaymentMethodData<T>) -> Self {
        match pm_data {
            ...
            PaymentMethodData::PayLater(pay_later_data) => match pay_later_data {
                ...
                payment_method_data::PayLaterData::PayLaterRedirect {} => Self::PayLaterRedirect,
            },
    ...
    for ConnectorVariant
{
    ...
    fn foreign_try_from(
        ...
        match auth_type {
            ...
            AuthType::Paylater(_) => Ok(Self::Payment(ConnectorEnum::Paylater)),
