...
impl Connectors {
    ...
    pub fn patch_connector_urls(
        ...
        match connector {
            ...
            ConnectorEnum::Paylater => {
                patched.paylater.apply(params_patch);
            }
            _ => {
                    ...
                    context: IntegrationErrorContext {
                        additional_context: Some(format!(
                            "Connector '{}' is not supported for dynamic URL patching from superposition. \
                             Supported connectors: stripe, adyen, paypal, braintree, checkout, cybersource, revolut, aci, bankofamerica, worldpay, rapyd, fiserv, nexinets, elavon, novalnet, trustpay, forte, bambora, bamboraapac, barclaycard, billwerk, bluesnap, calida, cashfree, celero, cryptopay, datatrans, finix, fiservcommercehub, fiservemea, globalpay, helcim, hipay, imerchantsolutions, jpmorgan, loonio, mifinity, mollie, moneris, multisafepay, nexixpay, payload, payme, tamara, placetopay, powertranz, revolv3, absa_sanlam, shift4, silverflow, stax, truelayer, trustly, trustpayments, tsys, wellsfargo, worldpayvantiv, worldpayxml, zift, gigadat, givepayments, boost, ilixium, paylater",
                            connector
                        )),
                        ..Default::default()
                    }
    ...
    pub fn convert_to_domain_model_for_non_card_payment_methods(
        ...
        match value.payment_method {
            Some(data) => match data {
                ...
                grpc_api_types::payments::payment_method::PaymentMethod::PayLaterRedirect(_) => Ok(
                    Self::PayLater(payment_method_data::PayLaterData::PayLaterRedirect {}),
                ),
                // ============================================================================
    ...
    fn foreign_try_from(
        ...
        match value.payment_method {
            Some(data) => match data {
                ...
                grpc_api_types::payments::payment_method::PaymentMethod::PayLaterRedirect(_) => Ok(Some(PaymentMethodType::PayLater)),
                // ============================================================================
...
impl ForeignTryFrom<grpc_api_types::payments::PaymentMethod> for PaymentMethod {
    ...
    fn foreign_try_from(
        ...
        match item {
            ...
            grpc_api_types::payments::PaymentMethod {
                payment_method:
                    Some(grpc_api_types::payments::payment_method::PaymentMethod::PayLaterRedirect(_)),
            } => Ok(Self::PayLater),
            grpc_api_types::payments::PaymentMethod {
                payment_method:
