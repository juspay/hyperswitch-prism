...
use domain_types::{
    ...
    connector_types::{
        ...
        RefundCancelPostRefundData, RefundFlowData, RefundSyncData, RefundWebhookDetailsResponse,
...
pub trait RefundCancelPostRefundV2:
    ConnectorIntegrationV2<
    connector_flow::CancelPostRefund,
    RefundFlowData,
