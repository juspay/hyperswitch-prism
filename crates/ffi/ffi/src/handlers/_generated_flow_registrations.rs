...
impl_flow_handlers!(accept, DisputeServiceAcceptRequest, DisputeServiceAcceptResponse, accept_req_transformer, accept_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(authenticate, PaymentMethodAuthenticationServiceAuthenticateRequest, PaymentMethodAuthenticationServiceAuthenticateResponse, authenticate_req_transformer, authenticate_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(authorize, PaymentServiceAuthorizeRequest, PaymentServiceAuthorizeResponse, authorize_req_transformer, authorize_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(create, CustomerServiceCreateRequest, CustomerServiceCreateResponse, create_req_transformer, create_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(create_order, PaymentServiceCreateOrderRequest, PaymentServiceCreateOrderResponse, create_order_req_transformer, create_order_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(refund_get, RefundServiceGetRequest, RefundResponse, refund_get_req_transformer, refund_get_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(reverse, PaymentServiceReverseRequest, PaymentServiceReverseResponse, reverse_req_transformer, reverse_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(setup_recurring, PaymentServiceSetupRecurringRequest, PaymentServiceSetupRecurringResponse, setup_recurring_req_transformer, setup_recurring_res_transformer, domain_types::connector_types::ConnectorEnum);
...
impl_flow_handlers!(submit_evidence, DisputeServiceSubmitEvidenceRequest, DisputeServiceSubmitEvidenceResponse, submit_evidence_req_transformer, submit_evidence_res_transformer, domain_types::connector_types::ConnectorEnum);
// surcharge_calculate: SurchargeService.Calculate — Calculate surcharge fees for a payment amount before processing.
impl_flow_handlers!(surcharge_calculate, SurchargeServiceCalculateRequest, SurchargeServiceCalculateResponse, surcharge_calculate_req_transformer, surcharge_calculate_res_transformer, domain_types::connector_types::SurchargeConnectorEnum);
...
impl_flow_handlers!(void, PaymentServiceVoidRequest, PaymentServiceVoidResponse, void_req_transformer, void_res_transformer, domain_types::connector_types::ConnectorEnum);
