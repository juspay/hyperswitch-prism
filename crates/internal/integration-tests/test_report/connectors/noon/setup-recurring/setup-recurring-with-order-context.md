...
```text
sdk call failed: sdk request transformer failed for 'setup_recurring/setup_recurring_with_order_context': Missing required field: order_category in metadata (code: BAD_REQUEST)
```
