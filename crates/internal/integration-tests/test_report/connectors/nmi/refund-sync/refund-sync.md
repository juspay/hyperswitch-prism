# Connector `nmi` / Suite `refund_sync` / Scenario `Refund Sync`
...
{
  "merchant_customer_id": "mcui_cb6b177377924217838f68ec",
  "customer_name": "Mia Johnson",
  "email": {
    "value": "sam.9591@example.com"
  },
  "phone_number": "+448859885043",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ethan"
...
{
  "merchant_transaction_id": "mti_f4c613c4955d43b998d654e1",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Brown",
    "email": {
      "value": "sam.4815@example.com"
    },
    "id": "cust_344de13f7c7f4a289d64af2e",
    "phone_number": "+915815063354"
  },
  "browser_info": {
...
{
  "merchant_refund_id": "mri_efb16128010e4c519c645f6e",
