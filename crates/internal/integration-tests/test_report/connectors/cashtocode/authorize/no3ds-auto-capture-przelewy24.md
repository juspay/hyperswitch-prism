# Connector `cashtocode` / Suite `authorize` / Scenario `Przelewy24 | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_e804434811c34bb2b242f279",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Noah Johnson",
    "email": {
      "value": "casey.3212@testmail.io"
    },
    "id": "cust_c6533cb9ce0840e69674bd74",
    "phone_number": "+449130907132"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "PL",
      "email": {
        "value": "alex.1488@sandbox.example.com"
      },
      "phone_number": {
        "value": "1265328096"
      },
