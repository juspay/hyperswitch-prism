# Connector `forte` / Suite `capture` / Scenario `Capture | Merchant Order ID Reference`
...
date: Mon, 23 Mar 2026 18:49:22 GMT
x-request-id: capture_capture_with_merchant_order_id_req
...
{
  "merchant_customer_id": "mcui_5e1c86cac19f401ea9a26363",
  "customer_name": "Mia Taylor",
  "email": {
    "value": "morgan.1662@example.com"
  },
  "phone_number": "+916714490572",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ava"
      ...
      "email": {
        "value": "riley.6249@sandbox.example.com"
      },
      "phone_number": {
        "value": "4620915012"
      },
...
{
  "merchant_transaction_id": "mti_b305e6bf86f245ca97b562c9",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "morgan.4566@sandbox.example.com"
    },
    "id": "cust_c7b93c4b26b240cf863e00e5",
    "phone_number": "+12077602446"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_ee9025bf1b024c1c95f41fe4",
  "merchant_order_id": "gen_245919",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
