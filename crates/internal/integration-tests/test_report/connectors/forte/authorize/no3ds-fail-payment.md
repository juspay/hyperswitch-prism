# Connector `forte` / Suite `authorize` / Scenario `Payment Failure | No 3DS`
...
```text
assertion failed for field 'error.connector_details.message': expected 'Error[1]: The content in the request produced errors while parsing. Check that the content is correctly formatted for the Content-Type provided. Error[2]: Could not find member 'card_type' on object of type 'transaction'.' to contain 'decline'
```
...
{
  "merchant_transaction_id": "mti_afbe409cd7434215a4e6fde6",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Brown",
    "email": {
      "value": "riley.8101@example.com"
    },
    "id": "cust_6b38aaf9284d4fd2b4650bdb",
    "phone_number": "+12758906212"
  },
  "browser_info": {
