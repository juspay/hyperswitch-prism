# Connector `payu` / Suite `capture` / Scenario `capture_full_amount`
...
{
  "merchant_transaction_id": "mti_1b9a4802d11b448783b865c8",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Taylor",
    "email": {
      "value": "casey.7743@testmail.io"
    },
    "id": "cust_3b84c32236564b9cba1447d0",
    "phone_number": "+17461902548"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "jordan.7070@sandbox.example.com"
      },
      "phone_number": {
        "value": "3809359550"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_4efc02a440b6459a8f8898f2",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (integration-tests)",
