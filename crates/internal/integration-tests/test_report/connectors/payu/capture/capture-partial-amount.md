# Connector `payu` / Suite `capture` / Scenario `capture_partial_amount`
...
date: Tue, 24 Mar 2026 07:05:40 GMT
x-request-id: capture_capture_partial_amount_req
...
{
  "merchant_transaction_id": "mti_3dc8943a5c91416fb1b79c7c",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Smith",
    "email": {
      "value": "casey.4044@testmail.io"
    },
    "id": "cust_19d2fee3588b4c10b6e7f0b0",
    "phone_number": "+19180053930"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.1768@sandbox.example.com"
      },
      "phone_number": {
        "value": "7903395531"
      },
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "9377 Sunset Dr"
      },
      "line3": {
        "value": "1407 Main Blvd"
      },
      "city": {
        "value": "Chicago"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_e572c150efbb4b93b0e6e23a",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (integration-tests)",
