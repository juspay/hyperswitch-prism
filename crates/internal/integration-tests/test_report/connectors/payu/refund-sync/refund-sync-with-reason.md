# Connector `payu` / Suite `refund_sync` / Scenario `Refund Sync | Reason`
...
{
  "merchant_transaction_id": "mti_97fe5c692afa43e08617c795",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Wilson",
    "email": {
      "value": "morgan.5644@sandbox.example.com"
    },
    "id": "cust_1837b086f3c24ff59967a075",
    "phone_number": "+918210622316"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "jordan.5257@sandbox.example.com"
      },
      "phone_number": {
        "value": "8176535115"
      },
...
{
  "merchant_refund_id": "mri_32446737a07a407a9d79157e",
