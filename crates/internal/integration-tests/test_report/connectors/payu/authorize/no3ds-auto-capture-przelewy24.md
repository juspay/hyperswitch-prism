# Connector `payu` / Suite `authorize` / Scenario `Przelewy24 | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_4c163c01fff141e187ebca82",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "jordan.1039@sandbox.example.com"
    },
    "id": "cust_1b2ed406a31c42d3b8eda9a3",
    "phone_number": "+915173186487"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.7184@sandbox.example.com"
      },
      "phone_number": {
        "value": "8013996791"
      },
