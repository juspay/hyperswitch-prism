# Connector `payu` / Suite `void` / Scenario `void_with_amount`
...
date: Tue, 24 Mar 2026 07:05:41 GMT
x-request-id: void_void_with_amount_req
...
{
  "merchant_transaction_id": "mti_77818ba404ba4325843c25b0",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "alex.1414@sandbox.example.com"
    },
    "id": "cust_773b9af2e0524fbebf860856",
    "phone_number": "+17893369497"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "6390 Market Dr"
      },
      "line2": {
        "value": "6657 Oak Dr"
      },
      "line3": {
        "value": "3942 Pine Blvd"
      },
      "city": {
        "value": "Los Angeles"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_18a23d1d48a64317b115f454",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_446913",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (integration-tests)",
