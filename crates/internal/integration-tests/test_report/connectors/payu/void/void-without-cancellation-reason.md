# Connector `payu` / Suite `void` / Scenario `Void | Without Cancellation Reason`
...
{
  "merchant_transaction_id": "mti_15e47b96384f4e71a9d04db1",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "jordan.8747@sandbox.example.com"
    },
    "id": "cust_b54ee87f287d40d59c7dc9df",
    "phone_number": "+445680778385"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "2157 Market St"
      },
      "line2": {
        "value": "2710 Oak Blvd"
      },
      "line3": {
        "value": "7794 Sunset St"
      },
      "city": {
        "value": "Chicago"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_5875902c46a340e69f5db162",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
