# Connector `authorizedotnet` / Suite `authorize` / Scenario `iDEAL | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_64e86033077742d69fddfc90",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Miller",
    "email": {
      "value": "alex.3605@example.com"
    },
    "id": "cust_13f7b5a6b676492ea9d0e7f8",
    "phone_number": "+19647485465",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method BankRedirect(Ideal { bank_name: None })"
    }
  },
  "statusCode": 501,
  "state": {
