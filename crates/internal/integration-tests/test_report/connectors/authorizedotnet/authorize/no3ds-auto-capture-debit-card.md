# Connector `authorizedotnet` / Suite `authorize` / Scenario `Debit Card | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_e6764acaa0a643a4b9f66f1e",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "jordan.5886@example.com"
    },
    "id": "cust_cee98ebd25074ffdb1431c6d",
    "phone_number": "+17709627684",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:27:22 GMT
x-request-id: authorize_no3ds_auto_capture_debit_card_req

Response contents:
{
  "merchantTransactionId": "80053224744",
  "connectorTransactionId": "80053224744",
  "status": "CHARGED",
  "statusCode": 200,
  "responseHeaders": {
    "access-control-allow-credentials": "true",
    ...
    "content-length": "653",
    "content-type": "application/json; charset=utf-8",
    "date": "Mon, 23 Mar 2026 18:27:21 GMT",
    "expires": "-1",
    "pragma": "no-cache",
    "strict-transport-security": "max-age=31536000; includeSubDomains",
    "x-cnection": "close",
    "x-download-options": "noopen",
    "x-opnet-transaction-trace": "f7f98837-27d3-43b1-8d07-b9e5c1850eb3-7572-12607302"
  },
  "networkTransactionId": "LNIRNRQQVU3HC4JHNF0FHWC",
  "state": {
    "connectorCustomerId": "525968092"
  },
