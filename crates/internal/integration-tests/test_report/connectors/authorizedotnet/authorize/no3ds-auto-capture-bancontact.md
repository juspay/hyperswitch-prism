# Connector `authorizedotnet` / Suite `authorize` / Scenario `Bancontact | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_6ed411ceefc344d6a2c45c30",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ava Johnson",
    "email": {
      "value": "jordan.2174@testmail.io"
    },
    "id": "cust_9701299008994d29b46a0ac1",
    "phone_number": "+911859677385",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method BankRedirect(BancontactCard { card_number: Some(CardNumber(411111**********)), card_exp_month: Some(*** alloc::string::String ***), card_exp_year: Some(*** alloc::string::String ***), card_holder_name: Some(*** alloc::string::String ***) })"
    }
  },
  "statusCode": 501,
  "state": {
