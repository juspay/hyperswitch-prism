# Connector `authorizedotnet` / Suite `authorize` / Scenario `Klarna | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_d34c905cf555458694c5e73b",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "riley.5237@sandbox.example.com"
    },
    "id": "cust_519657deb6254d62b2e3f5e7",
    "phone_number": "+911357504109",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method PayLater(KlarnaRedirect)"
    }
  },
  "statusCode": 501,
  "state": {
