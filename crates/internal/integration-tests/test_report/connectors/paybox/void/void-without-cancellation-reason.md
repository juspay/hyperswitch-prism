# Connector `paybox` / Suite `void` / Scenario `Void | Without Cancellation Reason`
...
date: Tue, 24 Mar 2026 07:05:00 GMT
x-request-id: void_void_without_cancellation_reason_req
...
{
  "merchant_transaction_id": "mti_fdedcb0ddcf04aa49de28707",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Brown",
    "email": {
      "value": "sam.3118@testmail.io"
    },
    "id": "cust_b50d40747619473fb0cde676",
    "phone_number": "+912904113876"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "alex.5623@sandbox.example.com"
      },
      "phone_number": {
        "value": "7544319212"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.6914@sandbox.example.com"
      },
      "phone_number": {
        "value": "4232419094"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_a8166dc358864047a1bf2bf3",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
