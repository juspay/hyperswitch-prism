# Connector `shift4` / Suite `authorize`
...
- [`Payment Failure | No 3DS`](./authorize/no3ds-fail-payment.md) — assertion failed for field 'error.connector_details.message': expected 'Provided API key is invalid' to contain 'decline'
