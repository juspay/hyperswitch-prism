# Connector `elavon` / Suite `authorize`
...
- [`Payment Failure | No 3DS`](./authorize/no3ds-fail-payment.md) — assertion failed for field 'error.connector_details.message': expected 'Failed to deserialize connector response' to contain 'decline'
