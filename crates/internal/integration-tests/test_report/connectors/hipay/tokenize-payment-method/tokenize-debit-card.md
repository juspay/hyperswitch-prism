# Connector `hipay` / Suite `tokenize_payment_method` / Scenario `tokenize_debit_card`
...
{
  "merchant_payment_method_id": "gen_583038",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "id": "cust_304369e12a334c3abcf9839c",
    "name": "Mia Johnson",
    "email": {
      "value": "morgan.3221@testmail.io"
    }
  },
  "address": {
    "billing_address": {
