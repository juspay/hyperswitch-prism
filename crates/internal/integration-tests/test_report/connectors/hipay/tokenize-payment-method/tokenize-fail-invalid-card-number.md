# Connector `hipay` / Suite `tokenize_payment_method` / Scenario `tokenize_fail_invalid_card_number`
...
{
  "merchant_payment_method_id": "gen_438248",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "id": "cust_26053af3bc4c4f4e89c3e551",
    "name": "Ethan Taylor",
    "email": {
      "value": "alex.5684@sandbox.example.com"
    }
  },
  "test_mode": true
}
