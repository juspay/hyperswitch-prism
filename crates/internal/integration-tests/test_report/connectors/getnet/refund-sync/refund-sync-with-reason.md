# Connector `getnet` / Suite `refund_sync` / Scenario `Refund Sync | Reason`
...
date: Tue, 24 Mar 2026 07:02:11 GMT
x-request-id: refund_sync_refund_sync_with_reason_req
...
{
  "merchant_transaction_id": "mti_ade123a7d966433fafbcfb42",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Taylor",
    "email": {
      "value": "alex.9141@testmail.io"
    },
    "id": "cust_8ddf5c93bb66476ab7b18cb0",
    "phone_number": "+442881278866"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line2": {
        "value": "6292 Market Rd"
      },
      "line3": {
        "value": "9051 Market Blvd"
      },
      "city": {
        "value": "Chicago"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "casey.7037@sandbox.example.com"
      },
      "phone_number": {
        "value": "8937217878"
      },
...
{
  "merchant_refund_id": "mri_2c2e2b1a667941ed87698d77",
