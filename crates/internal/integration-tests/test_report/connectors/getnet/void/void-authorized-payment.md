# Connector `getnet` / Suite `void` / Scenario `void_authorized_payment`
...
{
  "merchant_transaction_id": "mti_6fd82e9cf21c4491931c9e36",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    ...
    "id": "cust_8c93b221f6484ba690646b4d",
    "phone_number": "+16992031432"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "sam.8145@sandbox.example.com"
      },
      "phone_number": {
        "value": "8592271359"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "8684 Sunset St"
      },
      "line2": {
        "value": "6263 Sunset Rd"
      },
      "line3": {
        "value": "6108 Sunset Ave"
      },
      "city": {
        "value": "Austin"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_3dcdfebe52d14ac0a911a5b7",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (integration-tests)",
