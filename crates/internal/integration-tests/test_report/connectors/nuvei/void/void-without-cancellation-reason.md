# Connector `nuvei` / Suite `void` / Scenario `Void | Without Cancellation Reason`
...
date: Mon, 23 Mar 2026 16:21:12 GMT
x-request-id: create_customer_create_customer_req
...
{
  "merchant_customer_id": "mcui_8656f36a62644bc0bac89e4a4f26d204",
  "customer_name": "Noah Wilson",
  "email": {
    "value": "casey.6688@sandbox.example.com"
  },
  "phone_number": "+915349593118",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ethan"
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "9068 Market Blvd"
      },
      "line2": {
        "value": "7098 Market Ave"
      },
      "line3": {
        "value": "823 Sunset Blvd"
      },
      "city": {
        "value": "Los Angeles"
      },
...
{
  "merchant_transaction_id": "mti_90b6f352fb2249c8b836e23f28d737f1",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Taylor",
    "email": {
      "value": "sam.1047@example.com"
    },
    "id": "cust_ff766c5dc63449099bcebeaba4d17671",
    "phone_number": "+12233341266"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_459de770d30a4d1fb4fc0e08d62937fb",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  }
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "server": "nginx",
    "set-cookie": "JSESSIONID=b80174f30e5381b9add1205f7811; Path=/ppp; Secure; HttpOnly; SameSite=None"
  },
