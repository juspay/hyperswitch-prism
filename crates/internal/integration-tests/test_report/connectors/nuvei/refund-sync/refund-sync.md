# Connector `nuvei` / Suite `refund_sync` / Scenario `Refund Sync`
...
```text
assertion failed for field 'error': expected field to be absent or null, got {"connectorDetails":{"code":"1019","message":"Validation Error","reason":"Validation Error"}}
```
...
date: Mon, 23 Mar 2026 16:21:07 GMT
x-request-id: create_customer_create_customer_req
...
{
  "merchant_customer_id": "mcui_57b857faaa1d46b483e8e0ceaa564716",
  "customer_name": "Emma Johnson",
  "email": {
    "value": "riley.3506@testmail.io"
  },
  "phone_number": "+916122051588",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Emma"
      ...
      "line1": {
        "value": "6260 Market Ln"
      },
      "line2": {
        "value": "3492 Main St"
      },
      "line3": {
        "value": "7014 Sunset Blvd"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "2479 Main Blvd"
      },
      "line2": {
        "value": "882 Main Rd"
      },
      "line3": {
        "value": "9742 Market Blvd"
      },
      "city": {
        "value": "Seattle"
      },
...
{
  "merchant_transaction_id": "mti_9f74e590a32c4cea99e5f35199656d25",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Smith",
    "email": {
      "value": "alex.8171@testmail.io"
    },
    "id": "cust_934c04e0cc4a45178fca6accfa2ffe40",
    "phone_number": "+15484926378"
  },
  "browser_info": {
...
{
  "merchant_refund_id": "mri_ec851690b69c4f4999c5133feee6d022",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "server": "nginx",
    "set-cookie": "JSESSIONID=b800426edeb52617ba76e377d09a; Path=/ppp; Secure; HttpOnly; SameSite=None"
  },
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:21:08 GMT
x-request-id: refund_sync_refund_sync_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "p3p": "CP=\"ALL ADM DEV PSAi COM NAV OUR OTR STP IND DEM\"",
    "server": "nginx",
    "set-cookie": "JSESSIONID=b8005affbfd2070e1d7bff06f3b3; Path=/ppp; Secure; HttpOnly; SameSite=None"
  },
  "rawConnectorResponse": "***MASKED***"
