# Connector `nuvei` / Suite `refund_sync` / Scenario `Refund Sync | Reason`
...
{
  "merchant_customer_id": "mcui_e2485bf50bb447a1bef84c0dcf238fea",
  "customer_name": "Noah Johnson",
  "email": {
    "value": "riley.1337@example.com"
  },
  "phone_number": "+448521687622",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Noah"
...
{
  "merchant_transaction_id": "mti_347efe0ea81a4ce8914a1bd77a63988a",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Miller",
    "email": {
      "value": "casey.3866@example.com"
    },
    "id": "cust_0c56ceacc38f4573a53e0582b5cad917",
    "phone_number": "+441875745258"
  },
  "browser_info": {
...
{
  "merchant_refund_id": "mri_a43d52c3043e44eaa7b4f57174500fc9",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "server": "nginx",
    "set-cookie": "JSESSIONID=b80090ef56f418fcc271b219d42c; Path=/ppp; Secure; HttpOnly; SameSite=None"
  },
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "p3p": "CP=\"ALL ADM DEV PSAi COM NAV OUR OTR STP IND DEM\"",
    "server": "nginx",
    "set-cookie": "JSESSIONID=b800aa23ee6f473d65f51edc0e75; Path=/ppp; Secure; HttpOnly; SameSite=None"
  },
  "rawConnectorResponse": "***MASKED***"
