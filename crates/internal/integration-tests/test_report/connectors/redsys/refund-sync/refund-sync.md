# Connector `redsys` / Suite `refund_sync` / Scenario `refund_sync`
...
{
  "merchant_transaction_id": "mti_13db0cccf21a470da8df84b9",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Smith",
    "email": {
      "value": "sam.9118@example.com"
    },
    "id": "cust_2b45ce5a357f43ac88089d2e",
    "phone_number": "+916658885215"
  },
  "browser_info": {
...
Response trailers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:10:24 GMT
x-request-id: refund_refund_full_amount_req
...
{
  "merchant_refund_id": "mri_54084b43c2544b178f228d78",
