# Connector `redsys` / Suite `authorize` / Scenario `EPS | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_3b881ff77f4f4d27acafaae5",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ava Brown",
    "email": {
      "value": "casey.6864@testmail.io"
    },
    "id": "cust_b97ad946f0684ae3984894c1",
    "phone_number": "+442163165110"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.3812@sandbox.example.com"
      },
      "phone_number": {
        "value": "1182205290"
      },
