...
- [`no3ds_auto_capture_google_pay_encrypted`](./authorize/no3ds-auto-capture-google-pay-encrypted.md) — grpcurl execution failed: [google_pay_token_gen] redsys/authorize/no3ds_auto_capture_google_pay_encrypted: npm exited with exit status: 1
...
- [`no3ds_fail_payment`](./authorize/no3ds-fail-payment.md) — assertion failed for field 'error.connector_details.message': expected 'Cards No3DS is not supported by Redsys' to contain 'decline'
