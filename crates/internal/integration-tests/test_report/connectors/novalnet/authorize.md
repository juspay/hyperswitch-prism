# Connector `novalnet` / Suite `authorize`
...
- [`Payment Failure | No 3DS`](./authorize/no3ds-fail-payment.md) — assertion failed for field 'error.connector_details.message': expected 'Credit card payment not possible: card expired' to contain 'decline'
