# Connector `novalnet` / Suite `post_authenticate` / Scenario `threeds_card_post_authenticate`
...
```text
unsupported suite 'post_authenticate' for grpcurl generation
```
...
```text
unsupported suite 'authenticate' for grpcurl generation
```
