# Connector `stax` / Suite `authenticate` / Scenario `threeds_card_authenticate`
...
date: Tue, 24 Mar 2026 07:31:45 GMT
x-request-id: authenticate_threeds_card_authenticate_req
...
Response trailers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:31:44 GMT
x-request-id: pre_authenticate_threeds_card_pre_authenticate_req
Sent 1 request and received 0 responses
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Mia Brown",
    "email": {
      "value": "morgan.2833@sandbox.example.com"
    },
    "id": "cust_5efa1bf75cd1421e9c9f38ec",
    "phone_number": "+18178550759"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.5270@sandbox.example.com"
      },
      "phone_number": {
        "value": "8286936107"
      },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_f0660560ab0045eaa462e75a"
  },
  "metadata": {
    "value": "{}"
  },
