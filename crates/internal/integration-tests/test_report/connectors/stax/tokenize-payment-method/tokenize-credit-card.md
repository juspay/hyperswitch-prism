# Connector `stax` / Suite `tokenize_payment_method` / Scenario `Tokenize Payment Method | Tokenize Credit Card`
...
{
  "merchant_payment_method_id": "gen_215257",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "id": "cust_e6e38ee8be1a45ff81bfe801",
    "name": "Liam Miller",
    "email": {
      "value": "jordan.5375@example.com"
    },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:33:36 GMT
x-request-id: tokenize_payment_method_tokenize_credit_card_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "cache-control": "no-cache, private",
    "cf-cache-status": "DYNAMIC",
    "cf-ray": "9e13fd0fc9224734-BOM",
    "connection": "keep-alive",
    "content-type": "application/json",
    "date": "Tue, 24 Mar 2026 07:33:36 GMT",
    "server": "cloudflare",
    "set-cookie": "__cf_bm=8HHOTMJr52dV2tr9cH4KX6KtITaCdji_3sNERBM75Ec-1774337615.3295288-1.0.1.1-IS9Wr4H9C7OAPWHyYux2.m9rvp5Z1xIKVobeZ4GtnD4NnXp5.A0dAWVUbmzvgq8K2.Ljile8HUCPbFDzfzRtSRbjFexqo6L1hQ1bieQGYA5kdMsLwJuE5JsuDEPaepVo; HttpOnly; Secure; Path=/; Domain=fattlabs.com; Expires=Tue, 24 Mar 2026 08:03:36 GMT",
    "transfer-encoding": "chunked",
