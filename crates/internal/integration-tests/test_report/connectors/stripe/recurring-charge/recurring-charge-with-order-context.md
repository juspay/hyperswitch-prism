# Connector `stripe` / Suite `recurring_charge` / Scenario `Recurring Charge | Order Context`
...
{
  "merchant_charge_id": "mchi_500156ef4415487fbc03ae6d9dde7204",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 15:48:17 GMT
x-request-id: recurring_charge_recurring_charge_with_order_context_req

Response contents:
{
  "connectorTransactionId": "pi_3TEAiBD5R7gDAGff1vAu06cx",
  "status": "CHARGED",
  "statusCode": 200,
  "responseHeaders": {
    "access-control-allow-credentials": "true",
    ...
    "idempotency-key": "57e2b24a-4216-4f8a-b2fe-a53dd3125458",
    "original-request": "req_nKjqg5W3S5EtfB",
    "request-id": "req_nKjqg5W3S5EtfB",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
  ...
  "merchantChargeId": "pi_3TEAiBD5R7gDAGff1vAu06cx",
  "mandateReference": {
    "connectorMandateId": {
      "connectorMandateId": "pm_1TEAi6D5R7gDAGffX0EtXYPi",
      "paymentMethodId": "pm_1TEAi6D5R7gDAGffX0EtXYPi"
