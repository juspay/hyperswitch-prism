...
{
  "merchant_charge_id": "mchi_808041d15b99438792b6ceb7",
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 08:50:20 GMT
x-request-id: recurring_charge_recurring_charge_low_amount_req

Response contents:
{
  "connectorTransactionId": "pi_3TEQfGD5R7gDAGff00UYBP83",
  "status": "CHARGED",
  "statusCode": 200,
  "responseHeaders": {
    "access-control-allow-credentials": "true",
    ...
    "content-security-policy": "base-uri 'none'; default-src 'none'; form-action 'none'; frame-ancestors 'none'; img-src 'self'; script-src 'self' 'report-sample'; style-src 'self'; worker-src 'none'; upgrade-insecure-requests; report-uri https://q.stripe.com/csp-violation?q=cf2m0QZllQ_cO_-ua0bmze_ZEC6zU5cKsor4N_WReyb_KG6mR6TnzmyVa9YaYVkePdSCzFeftRkot2ZX",
    "content-type": "application/json",
    "date": "Tue, 24 Mar 2026 08:50:19 GMT",
    "idempotency-key": "b20d0330-d57b-4be9-9ce0-18a32d57bc1c",
    "original-request": "req_nyYUEokQMPndoO",
    "request-id": "req_nyYUEokQMPndoO",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
  ...
  "merchantChargeId": "pi_3TEQfGD5R7gDAGff00UYBP83",
  "mandateReference": {
    "connectorMandateId": {
      "connectorMandateId": "pm_1TEQfED5R7gDAGffTHmpu9oS",
      "paymentMethodId": "pm_1TEQfED5R7gDAGffTHmpu9oS"
