# Connector `stripe` / Suite `tokenize_payment_method` / Scenario `Tokenize Payment Method | Tokenize With Metadata`
...
{
  "merchant_payment_method_id": "gen_144135",
  "amount": {
    "minor_amount": 0,
    "currency": "USD"
  },
  ...
  "customer": {
    "id": "cust_6148bb04bd1e4e708b986d429a15d5c3",
    "name": "Mia Miller",
    "email": {
      "value": "morgan.8139@example.com"
    }
  },
  "metadata": {
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:48:21 GMT",
    "idempotency-key": "adcaffd3-c701-42f3-a895-c04457514b00",
    "original-request": "req_Px6dWJCtqkDjV3",
    "request-id": "req_Px6dWJCtqkDjV3",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-version": "2022-11-15",
    "vary": "Origin",
