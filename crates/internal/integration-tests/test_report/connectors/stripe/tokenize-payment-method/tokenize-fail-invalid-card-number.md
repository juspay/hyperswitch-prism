# Connector `stripe` / Suite `tokenize_payment_method` / Scenario `Tokenize Payment Method | Tokenize Fail Invalid Card Number`
...
{
  "merchant_payment_method_id": "gen_954574",
  "amount": {
    "minor_amount": 0,
    "currency": "USD"
  },
  ...
  "customer": {
    "id": "cust_39239d9342634a17bb3b0416ec920eec",
    "name": "Ethan Taylor",
    "email": {
      "value": "sam.6611@sandbox.example.com"
    }
  },
  "test_mode": true
}
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:48:20 GMT",
    "idempotency-key": "a5330c8b-19b1-4b3b-a19a-c00615e43c74",
    "original-request": "req_frCnYg5w7N7kp9",
    "request-id": "req_frCnYg5w7N7kp9",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-version": "2022-11-15",
    "vary": "Origin",
