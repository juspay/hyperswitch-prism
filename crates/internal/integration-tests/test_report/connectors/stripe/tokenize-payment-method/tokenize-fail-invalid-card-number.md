# Connector `stripe` / Suite `tokenize_payment_method` / Scenario `tokenize_fail_invalid_card_number`
...
{
  "merchant_payment_method_id": "gen_128185",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "id": "cust_54100658eb15483480bf061b",
    "name": "Noah Taylor",
    "email": {
      "value": "morgan.7381@sandbox.example.com"
    },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 08:50:25 GMT
x-request-id: tokenize_payment_method_tokenize_fail_invalid_card_number_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Tue, 24 Mar 2026 08:50:25 GMT",
    "idempotency-key": "3b0ce5c7-1abf-4e83-9c73-70da9c7bee27",
    "original-request": "req_se4YvxHC1hNQJm",
    "request-id": "req_se4YvxHC1hNQJm",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-version": "2022-11-15",
    "vary": "Origin",
