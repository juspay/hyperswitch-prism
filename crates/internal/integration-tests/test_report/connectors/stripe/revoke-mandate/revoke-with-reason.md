# Connector `stripe` / Suite `revoke_mandate` / Scenario `Revoke Mandate | Revoke With Reason`

- Service: `Unknown`
- Scenario Key: `revoke_with_reason`
- PM / PMT: `-` / `-`
- Result: `FAIL`
...
date: Mon, 23 Mar 2026 15:48:23 GMT
x-request-id: revoke_mandate_revoke_with_reason_req
...
{
  "merchant_revoke_id": "gen_437630",
  "mandate_id": "gen_997285",
  "connector_mandate_id": "gen_188707"
}
JSON
```
