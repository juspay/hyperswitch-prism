...
x-connector-request-reference-id: revoke_mandate_revoke_fail_invalid_mandate_id_ref
...
grpcurl -plaintext \
  -H "x-merchant-id: test_merchant" \
  -H "x-tenant-id: default" \
  -H "x-request-id: revoke_mandate_revoke_fail_invalid_mandate_id_req" \
  -H "x-connector-request-reference-id: revoke_mandate_revoke_fail_invalid_mandate_id_ref" \
  -H "x-connector-config: ***MASKED***" \
