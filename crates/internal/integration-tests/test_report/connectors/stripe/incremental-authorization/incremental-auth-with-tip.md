# Connector `stripe` / Suite `incremental_authorization` / Scenario `Incremental Authorization | Incremental Auth With Tip`

- Service: `Unknown`
- Scenario Key: `incremental_auth_with_tip`
- PM / PMT: `-` / `-`
- Result: `FAIL`
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:48:27 GMT",
    "idempotency-key": "b2768582-fbaf-4e25-ad9b-0af16baaa69c",
    "original-request": "req_1olKRWTaTlcYpi",
    "request-id": "req_1olKRWTaTlcYpi",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-version": "2022-11-15",
    "vary": "Origin",
