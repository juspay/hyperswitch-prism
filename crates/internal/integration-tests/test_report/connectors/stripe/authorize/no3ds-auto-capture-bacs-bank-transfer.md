# Connector `stripe` / Suite `authorize` / Scenario `BACS Bank Transfer | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_748281e552b54ae980cd3f9ecf19e8d4",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Ava Johnson",
    "email": {
      "value": "sam.5254@example.com"
    },
    "id": "cust_54c1612beda947daa43abb7dc0a3b4b1",
    "phone_number": "+446850274930",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 15:46:28 GMT
x-request-id: authorize_no3ds_auto_capture_bacs_bank_transfer_req
...
Response contents:
{
  "error": {
    ...
    "connectorDetails": {
      "code": "No error code",
      "message": "The currency provided (gbp) is invalid. Payments with customer_balance support the following currencies: eur, usd.",
      "reason": "The currency provided (gbp) is invalid. Payments with customer_balance support the following currencies: eur, usd."
    }
  },
  "statusCode": 400,
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:46:28 GMT",
    "idempotency-key": "906afd0b-c76b-4dae-9eb3-1af958bb9367",
    "original-request": "req_R9LTBcQK9yXSo0",
    "request-id": "req_R9LTBcQK9yXSo0",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
