# Connector `stripe` / Suite `authorize` / Scenario `Klarna | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_8c8df0807af34ccab560147e4fc256a1",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Taylor",
    "email": {
      "value": "jordan.4065@sandbox.example.com"
    },
    "id": "cust_6f99acdbbd024f8abebe81e0e7aab8c3",
    "phone_number": "+913173526522",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 15:46:37 GMT
x-request-id: authorize_no3ds_auto_capture_klarna_req

Response contents:
{
  "merchantTransactionId": "pi_3TEAgaD5R7gDAGff0GqD8z4j",
  "connectorTransactionId": "pi_3TEAgaD5R7gDAGff0GqD8z4j",
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:46:37 GMT",
    "idempotency-key": "639ee336-6449-4c54-9e69-c7f17ea6967d",
    "original-request": "req_bFryRbnBb5h9xZ",
    "request-id": "req_bFryRbnBb5h9xZ",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
  ...
  "redirectionData": {
    "form": {
      "endpoint": "https://pm-redirects.stripe.com/authorize/acct_1M7fTaD5R7gDAGff/pa_nonce_UCZqbnL1YPV3YGE3hvpSKGXsCIUh2CF",
      "method": "HTTP_METHOD_GET",
      "formFields": {
        "followRedirectsInSDK": "true",
        "useWebAuthSession": "true"
      }
    }
  },
  "state": {
  ...
  "mandateReference": {
    "connectorMandateId": {
      "connectorMandateId": "pm_1TEAgaD5R7gDAGffWuiiIJ65",
      "paymentMethodId": "pm_1TEAgaD5R7gDAGffWuiiIJ65"
    }
  }
}
