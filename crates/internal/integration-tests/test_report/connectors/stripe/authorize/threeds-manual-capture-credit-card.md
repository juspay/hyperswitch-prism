# Connector `stripe` / Suite `authorize` / Scenario `Credit Card | 3DS | Manual Capture`
...
{
  "merchant_transaction_id": "mti_ae8e1b5b594348e2ade58d53f30413f0",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "jordan.8033@sandbox.example.com"
    },
    "id": "cust_c4e6fa4e6eb24f79bcf5601d85f0186e",
    "phone_number": "+914292285600",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 15:46:45 GMT
x-request-id: authorize_threeds_manual_capture_credit_card_req

Response contents:
{
  "merchantTransactionId": "pi_3TEAgjD5R7gDAGff1V4AiiKI",
  "connectorTransactionId": "pi_3TEAgjD5R7gDAGff1V4AiiKI",
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:46:45 GMT",
    "idempotency-key": "c5722a4e-ae35-4479-96b2-2790766a1515",
    "original-request": "req_Yg302tHDtFb7Ap",
    "request-id": "req_Yg302tHDtFb7Ap",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
  ...
  "redirectionData": {
    "form": {
      ...
      "formFields": {
        ...
        "payment_intent": "pi_3TEAgjD5R7gDAGff1V4AiiKI",
        ...
        "source": "payatt_3TEAgjD5R7gDAGff1Dhgu0yC"
      }
    }
  },
  "state": {
  ...
  "mandateReference": {
    "connectorMandateId": {
      "connectorMandateId": "pm_1TEAgjD5R7gDAGffLY3bSRuz",
      "paymentMethodId": "pm_1TEAgjD5R7gDAGffLY3bSRuz"
    }
  }
}
