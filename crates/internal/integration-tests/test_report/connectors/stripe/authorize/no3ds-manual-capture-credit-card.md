# Connector `stripe` / Suite `authorize` / Scenario `Credit Card | No 3DS | Manual Capture`
...
{
  "merchant_transaction_id": "mti_10dc6c8127b64b6999d88c7e27c83496",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "alex.2706@sandbox.example.com"
    },
    "id": "cust_2016205c9ba3463681adacfb075850f4",
    "phone_number": "+447102280505",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 15:46:42 GMT
x-request-id: authorize_no3ds_manual_capture_credit_card_req

Response contents:
{
  "merchantTransactionId": "pi_3TEAgfD5R7gDAGff0X2CDmDF",
  "connectorTransactionId": "pi_3TEAgfD5R7gDAGff0X2CDmDF",
  "status": "AUTHORIZED",
  "statusCode": 200,
  "responseHeaders": {
    "access-control-allow-credentials": "true",
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:46:42 GMT",
    "idempotency-key": "6bb5010a-d131-4139-bef9-f8212d84e812",
    "original-request": "req_v9Wt4KNQ223zjc",
    "request-id": "req_v9Wt4KNQ223zjc",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
  ...
  "mandateReference": {
    "connectorMandateId": {
      "connectorMandateId": "pm_1TEAgfD5R7gDAGffw8kLwbaN",
      "paymentMethodId": "pm_1TEAgfD5R7gDAGffw8kLwbaN"
    }
  },
  "connectorResponse": {
