# Connector `stripe` / Suite `authorize` / Scenario `Przelewy24 | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_19b51775e3014a2892f585b52696d193",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Brown",
    "email": {
      "value": "morgan.5353@example.com"
    },
    "id": "cust_5ff6f964538446f890c4ee176c452def",
    "phone_number": "+19951248416",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 15:46:39 GMT
x-request-id: authorize_no3ds_auto_capture_przelewy24_req

Response contents:
{
  "merchantTransactionId": "pi_3TEAgcD5R7gDAGff0NU6KPGw",
  "connectorTransactionId": "pi_3TEAgcD5R7gDAGff0NU6KPGw",
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:46:39 GMT",
    "idempotency-key": "73c0acef-27fd-45ed-bd04-1e90834e0d3c",
    "original-request": "req_iBc5lOTn7dFN2G",
    "request-id": "req_iBc5lOTn7dFN2G",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
  ...
  "redirectionData": {
    "form": {
      "endpoint": "https://pm-redirects.stripe.com/authorize/acct_1M7fTaD5R7gDAGff/pa_nonce_UCZq36Mnuqq6UwdTvAA5HH4arpoh9fh",
  ...
  "mandateReference": {
    "connectorMandateId": {
      "connectorMandateId": "pm_1TEAgcD5R7gDAGffRL5oxG9Q",
      "paymentMethodId": "pm_1TEAgcD5R7gDAGffRL5oxG9Q"
    }
  }
}
