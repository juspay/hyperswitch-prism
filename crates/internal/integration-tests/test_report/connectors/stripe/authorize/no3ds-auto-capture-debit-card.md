# Connector `stripe` / Suite `authorize` / Scenario `Debit Card | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_724c060f1e1b46fb9c48eeb2ac0b1692",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "morgan.6268@testmail.io"
    },
    "id": "cust_57ef04d571a64fbcaf3a3f497c6ce009",
    "phone_number": "+447340040477",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 15:46:33 GMT
x-request-id: authorize_no3ds_auto_capture_debit_card_req

Response contents:
{
  "merchantTransactionId": "pi_3TEAgWD5R7gDAGff17vRucmR",
  "connectorTransactionId": "pi_3TEAgWD5R7gDAGff17vRucmR",
  "status": "CHARGED",
  "statusCode": 200,
  "responseHeaders": {
    "access-control-allow-credentials": "true",
    ...
    "content-type": "application/json",
    "date": "Mon, 23 Mar 2026 15:46:33 GMT",
    "idempotency-key": "38aa29cd-f1ac-4ac3-9f18-89e0c8c69f27",
    "original-request": "req_I6r2FiUNCJVz0F",
    "request-id": "req_I6r2FiUNCJVz0F",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
  ...
  "mandateReference": {
    "connectorMandateId": {
      "connectorMandateId": "pm_1TEAgWD5R7gDAGffV9hNX8s6",
      "paymentMethodId": "pm_1TEAgWD5R7gDAGffV9hNX8s6"
    }
  },
  "connectorResponse": {
