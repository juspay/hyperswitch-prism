# Connector `trustpay` / Suite `authorize`
...
- [`no3ds_fail_payment`](./authorize/no3ds-fail-payment.md) — assertion failed for field 'error.connector_details.message': expected 'The field Reference must be a string with a maximum length of 35.' to contain 'decline'
