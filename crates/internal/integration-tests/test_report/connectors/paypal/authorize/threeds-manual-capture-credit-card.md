...
{
  "merchant_transaction_id": "mti_b282e99a341f429abbad8263e352b541",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Brown",
    "email": {
      "value": "sam.3041@testmail.io"
    },
    "id": "cust_6e548f8a9f4d47da9daae74340846705",
    "phone_number": "+16156976673"
  },
  "state": {
    "access_token": ***MASKED***
      "token": ***MASKED***
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "5115 Pine Blvd"
      },
      "line2": {
        "value": "8198 Sunset Blvd"
      },
      "line3": {
        "value": "823 Lake Blvd"
      },
      ...
      "email": {
        "value": "riley.7370@sandbox.example.com"
      },
      "phone_number": {
        "value": "8448305811"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "3737 Market Blvd"
      },
      "line2": {
        "value": "7383 Sunset Ln"
      },
      "line3": {
        "value": "7354 Pine Ln"
      },
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:25:31 GMT
x-request-id: authorize_threeds_manual_capture_credit_card_req

Response contents:
{
  "connectorTransactionId": "33N53954G7771623E",
  ...
  "responseHeaders": {
    ...
    "paypal-debug-id": "f613711367045",
    "server": "nginx",
    "server-timing": "traceparent;desc=\"00-0000000000000000000f613711367045-7276ff531113677f-01\"",
    ...
    "x-timer": "S1774283130.637302,VS0,VE1754"
  },
  "redirectionData": {
    "form": {
