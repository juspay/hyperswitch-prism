...
|:---------|:--:|:---:|:------:|:--------------|
| [`no3ds_auto_capture_ach_bank_transfer`](./authorize/no3ds-auto-capture-ach-bank-transfer.md) | ach_bank_transfer | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_affirm`](./authorize/no3ds-auto-capture-affirm.md) | affirm | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_afterpay_clearpay`](./authorize/no3ds-auto-capture-afterpay-clearpay.md) | afterpay_clearpay | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_alipay`](./authorize/no3ds-auto-capture-alipay.md) | ali_pay_redirect | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_bacs_bank_transfer`](./authorize/no3ds-auto-capture-bacs-bank-transfer.md) | bacs_bank_transfer | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_bancontact`](./authorize/no3ds-auto-capture-bancontact.md) | bancontact_card | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
...
| [`no3ds_auto_capture_eps`](./authorize/no3ds-auto-capture-eps.md) | eps | - | `PASS` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_giropay`](./authorize/no3ds-auto-capture-giropay.md) | giropay | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_google_pay_encrypted`](./authorize/no3ds-auto-capture-google-pay-encrypted.md) | google_pay | CARD | `SKIP` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_ideal`](./authorize/no3ds-auto-capture-ideal.md) | ideal | - | `PASS` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_klarna`](./authorize/no3ds-auto-capture-klarna.md) | klarna | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_przelewy24`](./authorize/no3ds-auto-capture-przelewy24.md) | przelewy24 | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
| [`no3ds_auto_capture_sepa_bank_transfer`](./authorize/no3ds-auto-capture-sepa-bank-transfer.md) | sepa_bank_transfer | - | `FAIL` | `create_access_token(create_access_token)` (PASS) |
...
| [`threeds_manual_capture_credit_card`](./authorize/threeds-manual-capture-credit-card.md) | card | credit | `PASS` | `create_access_token(create_access_token)` (PASS) |
...
- [`no3ds_auto_capture_giropay`](./authorize/no3ds-auto-capture-giropay.md) — assertion failed for field 'error': expected field to be absent or null, got {"issuerDetails":{"networkDetails":{}},"connectorDetails":{"code":"PERMISSION_DENIED","message":"PERMISSION_DENIED","reason":"description - You do not have permission to access or perform operations on this resource.;"}}
