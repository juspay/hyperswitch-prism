# Connector `worldpayxml` / Suite `authorize`
...
- [`Credit Card | No 3DS | Automatic Capture`](./authorize/no3ds-auto-capture-credit-card.md) — assertion failed for field 'status': expected one of ["CHARGED", "AUTHORIZED"], got "PENDING"
- [`Debit Card | No 3DS | Automatic Capture`](./authorize/no3ds-auto-capture-debit-card.md) — assertion failed for field 'status': expected one of ["CHARGED", "AUTHORIZED"], got "PENDING"
