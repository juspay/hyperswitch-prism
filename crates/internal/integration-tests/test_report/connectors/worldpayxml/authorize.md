...
- [`no3ds_auto_capture_credit_card`](./authorize/no3ds-auto-capture-credit-card.md) — assertion failed for field 'status': expected one of ["CHARGED", "AUTHORIZED"], got "PENDING"
- [`no3ds_auto_capture_debit_card`](./authorize/no3ds-auto-capture-debit-card.md) — assertion failed for field 'status': expected one of ["CHARGED", "AUTHORIZED"], got "PENDING"
