# Connector `cryptopay` / Suite `get` / Scenario `Get | Sync Payment`
...
```text
assertion failed for field 'error': expected field to be absent or null, got {"issuerDetails":{"networkDetails":{}},"connectorDetails":{"code":"api_key_expired","message":"api key expired"}}
```
...
{
  "merchant_transaction_id": "mti_b8836ba8d4b041a7bf9bb466",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Miller",
    "email": {
      "value": "casey.7071@sandbox.example.com"
    },
    "id": "cust_c50dad5f59404ddd824df66d",
    "phone_number": "+917621970325"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "499 Market Ave"
      },
      "line2": {
        "value": "6160 Sunset Blvd"
      },
      "line3": {
        "value": "5572 Oak Rd"
      },
      ...
      "email": {
        "value": "morgan.6731@sandbox.example.com"
      },
      "phone_number": {
        "value": "8835588279"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.2960@sandbox.example.com"
      },
      "phone_number": {
        "value": "8525472549"
      },
