# Connector `cryptopay` / Suite `authorize`
...
- [`Payment Failure | No 3DS`](./authorize/no3ds-fail-payment.md) — assertion failed for field 'error.connector_details.message': expected 'This step has not been implemented for: Selected payment method through CryptoPay' to contain 'decline'
