# Connector `globalpay` / Suite `authorize`
...
- [`no3ds_fail_payment`](./authorize/no3ds-fail-payment.md) — assertion failed for field 'error.connector_details.message': expected 'Failed to obtain authentication type' to contain 'decline'
