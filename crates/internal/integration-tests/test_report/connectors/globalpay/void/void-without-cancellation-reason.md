# Connector `globalpay` / Suite `void` / Scenario `Void | Without Cancellation Reason`
...
{
  "merchant_customer_id": "mcui_5d7df3d64f0248e9870a53f4",
  "customer_name": "Mia Taylor",
  "email": {
    "value": "riley.1818@example.com"
  },
  "phone_number": "+916998947821",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Emma"
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.7423@sandbox.example.com"
      },
      "phone_number": {
        "value": "2766518256"
      },
...
{
  "merchant_transaction_id": "mti_38206209aa0841eca63cbdc5",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Johnson",
    "email": {
      "value": "alex.6044@example.com"
    },
    "id": "cust_5238db23fd1c4d009203270a",
    "phone_number": "+911365334478"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_9dc00632d51440858caa9e94",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:52:10 GMT
x-request-id: void_void_without_cancellation_reason_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "x-request-id": "c61f2568-a81c-4b09-a5df-918457d49b531666735.1",
    "x_global_transaction_id": "rrt-df452582-011a-4be9-8f62-0e052a1c9b294q94r",
