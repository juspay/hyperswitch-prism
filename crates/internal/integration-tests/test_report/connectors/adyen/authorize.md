# Connector `adyen` / Suite `authorize`
...
- [`no3ds_auto_capture_affirm`](./authorize/no3ds-auto-capture-affirm.md) — assertion failed for field 'error': expected field to be absent or null, got {"issuerDetails":{"networkDetails":{}},"connectorDetails":{"code":"No error code","message":"No error message"}}
...
- [`no3ds_auto_capture_google_pay_encrypted`](./authorize/no3ds-auto-capture-google-pay-encrypted.md) — grpcurl execution failed: [google_pay_token_gen] adyen/authorize/no3ds_auto_capture_google_pay_encrypted: npm exited with exit status: 1
- [`no3ds_auto_capture_klarna`](./authorize/no3ds-auto-capture-klarna.md) — Resolved method descriptor:
