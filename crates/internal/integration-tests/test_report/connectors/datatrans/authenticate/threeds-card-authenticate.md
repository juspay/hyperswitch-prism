# Connector `datatrans` / Suite `authenticate` / Scenario `threeds_card_authenticate`
...
date: Mon, 23 Mar 2026 18:41:47 GMT
x-request-id: authenticate_threeds_card_authenticate_req
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    ...
    "id": "cust_49bcd8f912bc43189a8741af",
    "phone_number": "+916188037847"
  },
  "address": {
    "shipping_address": {
      "first_name": {
      ...
      "line2": {
        "value": "5503 Market Ln"
      },
      "line3": {
        "value": "2747 Lake Blvd"
      },
      "city": {
        "value": "San Francisco"
      },
      ...
      "email": {
        "value": "casey.8228@sandbox.example.com"
      },
      "phone_number": {
        "value": "3677675173"
      },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_805c1b3eaf5e4a09bbc1a984"
  },
  "metadata": {
    "value": "{}"
  },
