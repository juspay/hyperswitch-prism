# Connector `aci` / Suite `authorize` / Scenario `Giropay | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_8e2e17c970ed4ddd9a81e4f6",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Miller",
    "email": {
      "value": "jordan.9636@sandbox.example.com"
    },
    "id": "cust_a59d457d1d4848d79f651c9a",
    "phone_number": "+446851599611"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.3232@sandbox.example.com"
      },
      "phone_number": {
        "value": "1866806433"
      },
