# Connector `airwallex` / Suite `void` / Scenario `Void | Amount`
...
{
  "merchant_transaction_id": "mti_955254eb08b64151b765a9dc",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "jordan.3441@sandbox.example.com"
    },
    "id": "cust_69b48a2d174149499c07b171",
    "phone_number": "+914454101572"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "4469 Market Ln"
      },
      "line2": {
        "value": "8313 Oak St"
      },
      "line3": {
        "value": "8558 Sunset Dr"
      },
      "city": {
        "value": "Seattle"
      },
...
date: Tue, 24 Mar 2026 05:15:49 GMT
x-request-id: authorize_no3ds_manual_capture_credit_card_req
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_d38c612d880849a08264d182",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_264590",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 05:15:49 GMT",
    "server": "APISIX",
    "server-timing": "traceparent;desc=\"00-8d5efde830291bd462aaf342bedd7963-2018baa506db83cb-01\"",
    "strict-transport-security": "max-age=15552000",
    "via": "1.1 google, 1.1 google, 1.1 google",
    "x-b3-traceid": "8d5efde830291bd462aaf342bedd7963",
