# Connector `airwallex` / Suite `void` / Scenario `Void | Authorized Payment`
...
{
  "merchant_transaction_id": "mti_76a6d26454804640acbfad00",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Smith",
    "email": {
      "value": "morgan.2747@testmail.io"
    },
    "id": "cust_652c02442e364446a7789512",
    "phone_number": "+16036448828"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_d430ed4eee234e75b9cab30f",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 05:15:48 GMT",
    "server": "APISIX",
    "server-timing": "traceparent;desc=\"00-47f94666a706c12f62aaf342bedd7747-a33c3d3a7fa4cd96-01\"",
    "strict-transport-security": "max-age=15552000",
    "via": "1.1 google, 1.1 google, 1.1 google",
    "x-b3-traceid": "47f94666a706c12f62aaf342bedd7747",
