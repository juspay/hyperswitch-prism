# Connector `bankofamerica` / Suite `authorize`
...
| [`Debit Card \| No 3DS \| Automatic Capture`](./authorize/no3ds-auto-capture-debit-card.md) | card | debit | `PASS` | `create_customer(create_customer)` (FAIL) |
...
| [`Debit Card \| No 3DS \| Manual Capture`](./authorize/no3ds-manual-capture-debit-card.md) | card | debit | `PASS` | `create_customer(create_customer)` (FAIL) |
| [`Credit Card \| 3DS \| Manual Capture`](./authorize/threeds-manual-capture-credit-card.md) | card | credit | `PASS` | `create_customer(create_customer)` (FAIL) |
