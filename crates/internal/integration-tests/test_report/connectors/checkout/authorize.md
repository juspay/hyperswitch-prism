# Connector `checkout` / Suite `authorize`
...
- [`threeds_manual_capture_credit_card`](./authorize/threeds-manual-capture-credit-card.md) — assertion failed for field 'error': expected field to be absent or null, got {"issuerDetails":{"networkDetails":{}},"connectorDetails":{"code":"no_processor_configured_for_card_scheme","message":"no_processor_configured_for_card_scheme","reason":"no_processor_configured_for_card_scheme"}}
