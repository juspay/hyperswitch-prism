# Connector `checkout` / Suite `authorize` / Scenario `SEPA Bank Transfer | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_09484698a0a74f1db386dff7",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Taylor",
    "email": {
      "value": "alex.3172@example.com"
    },
    "id": "cust_e199ed68820c4d49bdd5e6ee",
    "phone_number": "+911248530471"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "2894 Pine Blvd"
      },
      "line2": {
        "value": "3711 Market Ln"
      },
      "line3": {
        "value": "5604 Oak Ln"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "DE",
      "email": {
        "value": "casey.1099@sandbox.example.com"
      },
      "phone_number": {
        "value": "1197937346"
      },
...
date: Mon, 23 Mar 2026 18:39:07 GMT
x-request-id: authorize_no3ds_auto_capture_sepa_bank_transfer_req
