# Connector `mollie` / Suite `refund_sync` / Scenario `Refund Sync`
...
date: Tue, 24 Mar 2026 07:03:58 GMT
x-request-id: refund_sync_refund_sync_req
...
Response trailers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:03:57 GMT
x-request-id: create_customer_create_customer_req
Sent 1 request and received 0 responses
...
{
  "merchant_customer_id": "mcui_756f26f82cb14072b976bc6b",
  "customer_name": "Ava Taylor",
  "email": {
    "value": "riley.2278@sandbox.example.com"
  },
  "phone_number": "+913227724371",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Liam"
...
{
  "merchant_transaction_id": "mti_fded6f27927e4411907732b7",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "riley.8640@example.com"
    },
    "id": "cust_e4680a03c3404636a43a42a5",
    "phone_number": "+17730094026"
  },
  "browser_info": {
...
Response contents:
{
  "merchantTransactionId": "tr_CJRbMoWvHRqpYXAWTdrNJ",
  "connectorTransactionId": "tr_CJRbMoWvHRqpYXAWTdrNJ",
  ...
  "responseHeaders": {
    ...
    "x-mollie-api-gateway-requestid": "019d1ea84535762ea5064b63fd7235fb",
    "x-robots-tag": "noindex",
    "x-xss-protection": "1; mode=block"
  },
  "redirectionData": {
    "form": {
      "endpoint": "https://www.mollie.com/checkout/credit-card/session/CJRbMoWvHRqpYXAWTdrNJ",
...
{
  "merchant_refund_id": "mri_a91b0ca48bd342b1ae5200e1",
  "connector_transaction_id": "tr_CJRbMoWvHRqpYXAWTdrNJ",
  "payment_amount": 6000,
  "refund_amount": {
    "minor_amount": 6000,
    "currency": "USD"
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "strict-transport-security": "max-age=31536000; includeSubDomains; preload",
    "via": "1.1 google, 1.1 google",
    "x-mollie-api-gateway-requestid": "019d1ea847d97fc9aeef8fe6a2f13c59",
    "x-xss-protection": "1; mode=block"
  },
  "rawConnectorResponse": "***MASKED***"
