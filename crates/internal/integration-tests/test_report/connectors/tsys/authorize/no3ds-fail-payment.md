# Connector `tsys` / Suite `authorize` / Scenario `Payment Failure | No 3DS`
...
```text
assertion failed for field 'error.connector_details.message': expected 'CVV2 verification failed' to contain 'decline'
```
...
{
  "merchant_transaction_id": "mti_a04ae74fc1244eda8ebde9a2c821faad",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Miller",
    "email": {
      "value": "casey.8675@example.com"
    },
    "id": "cust_f1dd8e6a824a4212bc0c414ebca77cb2",
    "phone_number": "+911338255122"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:38:37 GMT
x-request-id: authorize_no3ds_fail_payment_req
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "reason": "CVV2 verification failed"
    }
  },
  "statusCode": 200,
  "responseHeaders": {
    ...
    "date": "Mon, 23 Mar 2026 16:38:37 GMT",
    "set-cookie": "TS01759047=01e2355088ae3b123e2c38fb9fada365b4db4f39b25d75d616c4c092a16727462157104138d49258d055f1545b0f1ef2a27ef98db1; Path=/; Secure; HttpOnly",
