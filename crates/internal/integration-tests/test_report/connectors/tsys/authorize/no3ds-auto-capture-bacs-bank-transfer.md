# Connector `tsys` / Suite `authorize` / Scenario `BACS Bank Transfer | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_31c71bef592747be82fb651506a621ff",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Noah Johnson",
    "email": {
      "value": "casey.7054@testmail.io"
    },
    "id": "cust_62ea1065e7cb4945a1bf606f64afc518",
    "phone_number": "+918457755198"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:38:30 GMT
x-request-id: authorize_no3ds_auto_capture_bacs_bank_transfer_req
