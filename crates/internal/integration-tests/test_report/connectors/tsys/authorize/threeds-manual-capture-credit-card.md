# Connector `tsys` / Suite `authorize` / Scenario `threeds_manual_capture_credit_card`
...
{
  "merchant_transaction_id": "mti_afcede7477a9461aa794a54d52bd8683",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Brown",
    "email": {
      "value": "casey.9141@example.com"
    },
    "id": "cust_96f5a188c2524ca2b75f46daa6238c03",
    "phone_number": "+444915775534"
  },
  "browser_info": {
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Three_ds payments through Tsys"
    }
  },
  "statusCode": 501
}
