# Connector `tsys` / Suite `get` / Scenario `Get | Sync Payment With Handle Response`
...
{
  "merchant_customer_id": "mcui_78558e79a8d94dd786ffed46d0346300",
  "customer_name": "Noah Smith",
  "email": {
    "value": "jordan.5256@sandbox.example.com"
  },
  "phone_number": "+11722893166",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Emma"
      ...
      "line1": {
        "value": "3381 Market Dr"
      },
      "line2": {
        "value": "8438 Market Blvd"
      },
      "line3": {
        "value": "1196 Oak Rd"
      },
      ...
      "email": {
        "value": "riley.9163@sandbox.example.com"
      },
      "phone_number": {
        "value": "2426507569"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "casey.1107@sandbox.example.com"
      },
      "phone_number": {
        "value": "4530725811"
      },
...
{
  "merchant_transaction_id": "mti_580e577ed9c242218eca6eecb138874f",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Taylor",
    "email": {
      "value": "jordan.9844@example.com"
    },
    "id": "cust_f3b65479fa7c406980c545be7a33ecc6",
    "phone_number": "+447098801750"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:38:54 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Mon, 23 Mar 2026 16:38:54 GMT",
    "set-cookie": "TS01759047=01e2355088e52bd71122d4377f7f4044b74405d017001b34d6740d93974d42f07afa1861fd2cd4c872a5356575cfc8e0cda56dbee7; Path=/; Secure; HttpOnly",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "cross-origin-resource-policy": "cross-origin",
    "date": "Mon, 23 Mar 2026 16:38:54 GMT",
    "set-cookie": "TS01759047=01e2355088d7905d8d8cb9dfcea0517d3acc984d58965f8e92e5bc09f80a291849ee7603fcee240db71f85c2da2a9f997adaee97f4; Path=/; Secure; HttpOnly",
    "transfer-encoding": "chunked",
