# Connector `bluesnap` / Suite `post_authenticate`
...
- [`Card Post Authenticate | 3DS`](./post-authenticate/threeds-card-post-authenticate.md) — unsupported suite 'post_authenticate' for grpcurl generation