...
```text
sdk call failed: sdk request transformer failed for 'authorize/no3ds_auto_capture_afterpay_clearpay': Payment method PayLater(AfterpayClearpayRedirect) is not supported by Nexixpay (code: BAD_REQUEST)
```
