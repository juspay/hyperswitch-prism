...
```text
sdk call failed: sdk request transformer failed for 'authorize/no3ds_auto_capture_bacs_bank_transfer': Payment method BankTransfer(BacsBankTransfer) is not supported by Nexixpay (code: BAD_REQUEST)
```
