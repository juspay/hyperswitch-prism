# Connector `nexixpay` / Suite `setup_recurring` / Scenario `Setup Recurring`
...
```text
sdk call failed: sdk HTTP request failed for 'setup_recurring'/'setup_recurring': builder error
```
