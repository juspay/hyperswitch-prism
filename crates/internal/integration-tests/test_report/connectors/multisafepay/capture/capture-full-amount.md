# Connector `multisafepay` / Suite `capture` / Scenario `capture_full_amount`
...
Response trailers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:55:58 GMT
x-request-id: create_customer_create_customer_req
Sent 1 request and received 0 responses
...
{
  "merchant_customer_id": "mcui_edd03e39b66d45f7be0b32de",
  "customer_name": "Mia Smith",
  "email": {
    "value": "sam.7028@sandbox.example.com"
  },
  "phone_number": "+448740845007",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ethan"
...
{
  "merchant_transaction_id": "mti_c6458f8d99424ec7bd7260db",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Johnson",
    "email": {
      "value": "alex.9289@sandbox.example.com"
    },
    "id": "cust_33328cd4dd39453fa0d0740d",
    "phone_number": "+19548029322"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_292ecd7161a74eb3a5409165",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (integration-tests)",
