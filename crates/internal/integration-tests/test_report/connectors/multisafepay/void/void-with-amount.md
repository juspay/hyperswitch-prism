...
{
  "merchant_customer_id": "mcui_e37491b687aa432c81e81800",
  "customer_name": "Ethan Smith",
  "email": {
    "value": "jordan.5395@example.com"
  },
  "phone_number": "+441344981106",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ethan"
      ...
      "email": {
        "value": "alex.4532@sandbox.example.com"
      },
      "phone_number": {
        "value": "8748832064"
      },
...
{
  "merchant_transaction_id": "mti_57e8183542cb480f8e4dd7b1",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "morgan.1902@testmail.io"
    },
    "id": "cust_3b4507adf7514900af5619ee",
    "phone_number": "+913440513077"
  },
  "browser_info": {
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "pragma": "no-cache",
    "server": "Apache",
    "set-cookie": "PHPSESSID=2df8vl0ao8io82g46pf9sggt3h; path=/",
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_42f73a00b5bc4bf188373d67",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_952263",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
