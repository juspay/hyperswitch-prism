# Connector `multisafepay` / Suite `authorize` / Scenario `Debit Card | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_51cd0f3596854e90947807c6",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 03:42:06 GMT
x-request-id: authorize_no3ds_auto_capture_debit_card_req
