# Connector `multisafepay` / Suite `refund_sync` / Scenario `refund_sync`
...
date: Tue, 24 Mar 2026 03:11:25 GMT
x-request-id: refund_sync_refund_sync_req
...
{
  "merchant_transaction_id": "mti_09d4b8a5ab9546aeba362730",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Johnson",
    "email": {
      "value": "jordan.5298@example.com"
    },
    "id": "cust_c3f472f01e8c43c1b02672ab",
    "phone_number": "+19663845072"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "2935 Sunset Rd"
      },
      "line2": {
        "value": "9925 Market Blvd"
      },
      "line3": {
        "value": "6148 Market St"
      },
      "city": {
        "value": "Los Angeles"
      },
...
{
  "merchant_refund_id": "mri_12d6cec5f10b45ef9c5bb074",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "pragma": "no-cache",
    "server": "Apache",
    "set-cookie": "PHPSESSID=jfbjg3nvvpn6ooocpiao7pic8n; path=/",
    "transfer-encoding": "chunked",
    "vary": "Accept-Encoding,Api_Key,Api_Token,Device_Token,Api_Trx_Token,User_Passport,Transaction_Id",
    "x-content-type-options": "nosniff",
    "x-request-id": "019d1dd3-61cc-7f87-b647-c0d3e08c6033"
  },
  "rawConnectorResponse": "***MASKED***"
  "rawConnectorRequest": "***MASKED***"
  }
