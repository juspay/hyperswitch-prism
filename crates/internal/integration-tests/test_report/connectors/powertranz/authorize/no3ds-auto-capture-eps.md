# Connector `powertranz` / Suite `authorize` / Scenario `EPS | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_eb4c967ea52b4e7e8c4d0d5d",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Noah Wilson",
    "email": {
      "value": "riley.2808@sandbox.example.com"
    },
    "id": "cust_f3e6933b28654909b28318dd",
    "phone_number": "+914742333944"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "AT",
      "email": {
        "value": "riley.5282@sandbox.example.com"
      },
      "phone_number": {
        "value": "8357023801"
      },
