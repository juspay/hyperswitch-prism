# Connector `wellsfargo` / Suite `authorize` / Scenario `Alipay | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_bf4906b02c6240f7811e1923b3aed9ab",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Wilson",
    "email": {
      "value": "jordan.2996@example.com"
    },
    "id": "cust_8e02cd6d26bc4d50af0c86ec770d7a3d",
    "phone_number": "+917298670086"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:41:48 GMT
x-request-id: authorize_no3ds_auto_capture_alipay_req
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method supported by connector but not yet implemented"
    }
  },
  "statusCode": 501
}
