# Connector `wellsfargo` / Suite `authenticate` / Scenario `Card Authenticate | 3DS`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ethan Miller",
    "email": {
      "value": "sam.5096@sandbox.example.com"
    },
    "id": "cust_157c8f3201df4a3b844b6d0b24a5a63b",
    "phone_number": "+441180096652"
  },
  "address": {
    "shipping_address": {
      "first_name": {
      ...
      "line1": {
        "value": "2772 Market Ave"
      },
      "line2": {
        "value": "2217 Sunset Rd"
      },
      "line3": {
        "value": "3661 Market Ave"
      },
      "city": {
        "value": "Austin"
      },
      ...
      "email": {
        "value": "alex.1529@sandbox.example.com"
      },
      "phone_number": {
        "value": "5055085752"
      },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_c4c6094bd3214e8e9bc8cdf35fe045a1"
  },
  "metadata": {
    "value": "{}"
  },
