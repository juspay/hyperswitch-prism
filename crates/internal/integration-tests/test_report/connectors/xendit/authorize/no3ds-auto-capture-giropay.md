# Connector `xendit` / Suite `authorize` / Scenario `Giropay | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_ff0dbece0ebd43529fc874bd",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "jordan.6083@testmail.io"
    },
    "id": "cust_90db48d80f894e5f8db00176",
    "phone_number": "+447889163099"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "DE",
      "email": {
        "value": "riley.6355@sandbox.example.com"
      },
      "phone_number": {
        "value": "4812764089"
      },
