# Connector `billwerk` / Suite `void` / Scenario `Void | Authorized Payment`
...
{
  "merchant_transaction_id": "mti_051593b747564ebb8cf0d7f4",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Wilson",
    "email": {
      "value": "casey.8385@testmail.io"
    },
    "id": "cust_6dfe5e13a8c14c908d32b75b",
    "phone_number": "+14923750020"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.2312@sandbox.example.com"
      },
      "phone_number": {
        "value": "7969927323"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_b53d7954be7c401289acd6ee",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 06:58:46 GMT",
    "request-id": "b5ce9037a0572c3b06cb13b586999f3c",
