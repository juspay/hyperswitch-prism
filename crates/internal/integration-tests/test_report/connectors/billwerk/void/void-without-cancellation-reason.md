# Connector `billwerk` / Suite `void` / Scenario `Void | Without Cancellation Reason`
...
{
  "merchant_transaction_id": "mti_10de41aada554322b972fba4",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Johnson",
    "email": {
      "value": "jordan.6838@example.com"
    },
    "id": "cust_3ac8c99603a148cb82974511",
    "phone_number": "+919552801976"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "5192 Market Ln"
      },
      "line2": {
        "value": "7800 Sunset Blvd"
      },
      "line3": {
        "value": "5369 Lake Ln"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "2014 Lake Blvd"
      },
      "line2": {
        "value": "2596 Main Blvd"
      },
      "line3": {
        "value": "8157 Pine Rd"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.6353@sandbox.example.com"
      },
      "phone_number": {
        "value": "4046609721"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_0eaf7f82921a4196ae557cee",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 06:58:47 GMT
x-request-id: void_void_without_cancellation_reason_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 06:58:47 GMT",
    "request-id": "69fa0d1880cdfd23194fcb55c5afb6be",
