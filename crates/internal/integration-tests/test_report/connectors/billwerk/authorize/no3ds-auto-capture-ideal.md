# Connector `billwerk` / Suite `authorize` / Scenario `iDEAL | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_3e0b14fbeeef462ca300c6ff",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "morgan.1430@sandbox.example.com"
    },
    "id": "cust_743114ab292048998d405249",
    "phone_number": "+15322349384"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "1781 Sunset Ln"
      },
      "line3": {
        "value": "5716 Sunset St"
      },
      "city": {
        "value": "Seattle"
      },
