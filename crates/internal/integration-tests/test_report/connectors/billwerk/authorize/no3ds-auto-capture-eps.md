# Connector `billwerk` / Suite `authorize` / Scenario `EPS | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_a2d13ec0421a42b1a327aa12",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Noah Wilson",
    "email": {
      "value": "morgan.9594@sandbox.example.com"
    },
    "id": "cust_754361ae17c84b1ba8b24f9d",
    "phone_number": "+917155971484"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "AT",
      "email": {
        "value": "morgan.1902@sandbox.example.com"
      },
      "phone_number": {
        "value": "3115506829"
      },
