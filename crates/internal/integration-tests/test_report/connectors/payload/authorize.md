...
- [`no3ds_auto_capture_debit_card`](./authorize/no3ds-auto-capture-debit-card.md) — assertion failed for field 'error': expected field to be absent or null, got {"issuerDetails":{"networkDetails":{}},"connectorDetails":{"code":"duplicate_attempt","message":"This transaction appears be a duplicate attempt and has been prevented.","reason":"This transaction appears be a duplicate attempt and has been prevented."}}
