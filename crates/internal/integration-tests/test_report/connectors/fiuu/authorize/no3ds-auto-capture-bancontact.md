# Connector `fiuu` / Suite `authorize` / Scenario `Bancontact | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_d57837e59b1a465abacba85a",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Liam Wilson",
    "email": {
      "value": "casey.3024@example.com"
    },
    "id": "cust_6a97153ab97549b68cce8fc8",
    "phone_number": "+446818988748"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "8333 Market Ave"
      },
      "line2": {
        "value": "9290 Main Blvd"
      },
      "line3": {
        "value": "9377 Pine Ln"
      },
      ...
      "email": {
        "value": "sam.3655@sandbox.example.com"
      },
      "phone_number": {
        "value": "8809775247"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "BE",
      "email": {
        "value": "casey.7385@sandbox.example.com"
      },
      "phone_number": {
        "value": "9865038708"
      },
