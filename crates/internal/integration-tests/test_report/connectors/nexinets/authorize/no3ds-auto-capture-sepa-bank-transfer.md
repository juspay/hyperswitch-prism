# Connector `nexinets` / Suite `authorize` / Scenario `SEPA Bank Transfer | No 3DS | Automatic Capture`
...
{
  "merchant_transaction_id": "mti_3d353f2d57bb46629e389fbe",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "casey.1152@example.com"
    },
    "id": "cust_813c303692bb407fa4c21802",
    "phone_number": "+912337825141"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line2": {
        "value": "1820 Market Ave"
      },
      "line3": {
        "value": "7641 Main Blvd"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "DE",
      "email": {
        "value": "jordan.8459@sandbox.example.com"
      },
      "phone_number": {
        "value": "2415976316"
      },
