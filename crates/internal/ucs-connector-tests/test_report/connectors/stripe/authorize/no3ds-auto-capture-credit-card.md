...
{
  "merchant_transaction_id": "mti_0dbf7a6ec8004686bfacb2164c9c3eed",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Smith",
    "email": {
      "value": "jordan.4245@example.com"
    },
    "id": "cust_8ad81ab628ac45c29abdbc59210aa649",
    "phone_number": "+17897027770",
...
Response headers received:
content-type: application/grpc
date: Fri, 13 Mar 2026 06:48:34 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req

Response contents:
{
  "merchantTransactionId": "pi_3TAPWPD5R7gDAGff1ToIw4G8",
  "connectorTransactionId": "pi_3TAPWPD5R7gDAGff1ToIw4G8",
  "status": "CHARGED",
  "statusCode": 200,
  "responseHeaders": {
    "access-control-allow-credentials": "true",
    ...
    "content-type": "application/json",
    "date": "Fri, 13 Mar 2026 06:48:34 GMT",
    "idempotency-key": "856667b1-a2bc-41e6-aeae-32031834b978",
    "original-request": "req_RUukmOyQqF9BB5",
    "request-id": "req_RUukmOyQqF9BB5",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-should-retry": "false",
    "stripe-version": "2022-11-15",
