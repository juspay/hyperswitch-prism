...
/// Full ISO country names. Ported from hyperswitch so connectors (e.g. Trustly's
/// ClearingHouse) that require the English country name can derive it from a
/// [`CountryAlpha2`] via [`Country::from_alpha2`].
#[derive(
    Clone,
    Copy,
    Debug,
