...
fn xendit_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn xendit_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for xendit"
    )))
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("create_order"))
    }
}
    ...
    for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("void"))
    }
}
    ...
    for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_flow_not_supported("accept_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("create_connector_customer"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("setup_mandate"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("payment_method_token"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("authenticate"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("post_authenticate"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("repeat_payment"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_flow_not_supported("void_post_capture"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("create_client_authentication_token"))
    }
}
    ...
    > for Xendit<T>
{
    fn get_url(
        ...
        Err(xendit_not_implemented("mandate_revoke"))
    }
}
