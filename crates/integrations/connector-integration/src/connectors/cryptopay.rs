...
fn cryptopay_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn cryptopay_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for cryptopay"
    )))
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("void_post_capture"))
    }
}
    ...
    for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("void"))
    }
}
    ...
    for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_not_implemented("refund_sync"))
    }
}
    ...
    for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_not_implemented("refund"))
    }
}
    ...
    for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("capture"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_not_implemented("setup_mandate"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("accept_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("submit_evidence"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("defend_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("create_order"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported(
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("server_authentication_token"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("payment_method_token"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("authenticate"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_flow_not_supported("client_authentication_token"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_not_implemented("create_connector_customer"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_not_implemented("mandate_revoke"))
    }
}
    ...
    > for Cryptopay<T>
{
    fn get_url(
        ...
        Err(cryptopay_not_implemented("repeat_payment"))
    }
}
