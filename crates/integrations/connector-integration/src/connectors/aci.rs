...
fn aci_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    ConnectorIntegrationV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData> for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("refund_sync"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("accept_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("submit_evidence"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("defend_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("create_order"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("client_authentication_token"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("server_authentication_token"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_not_implemented("payment_method_token"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("authenticate"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_not_implemented("void_post_capture"))
    }
}
    ...
    > for Aci<T>
{
    fn get_url(
        ...
        Err(aci_not_implemented("mandate_revoke"))
    }
}
