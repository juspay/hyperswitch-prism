...
fn cashfree_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn cashfree_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for cashfree"
    )))
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("setup_mandate"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("accept_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("submit_evidence"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("payment_method_token"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("create_connector_customer"))
    }
}
    ...
    for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("defend_dispute"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("repeat_payment"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_flow_not_supported("void_post_capture"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("authenticate"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("post_authenticate"))
    }
}
    ...
    > for Cashfree<T>
{
    fn get_url(
        ...
        Err(cashfree_not_implemented("mandate_revoke"))
    }
}
