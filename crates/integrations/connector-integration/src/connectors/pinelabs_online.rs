    ...
    for PinelabsOnline<T>
{
    fn get_url(
        ...
        Err(pinelabs_online_flow_not_supported("accept_dispute"))
    }
}
    ...
    for PinelabsOnline<T>
{
    fn get_url(
        ...
        Err(pinelabs_online_flow_not_supported("submit_evidence"))
    }
}
    ...
    for PinelabsOnline<T>
{
    fn get_url(
        ...
        Err(pinelabs_online_flow_not_supported("defend_dispute"))
    }
}
    ...
    > for PinelabsOnline<T>
{
    fn get_url(
        ...
        Err(pinelabs_online_flow_not_supported("void_post_capture"))
    }
}
