    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("authenticate"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("post_authenticate"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("void_post_capture"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("payment_method_token"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("create_connector_customer"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented(
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("mandate_revoke"))
    }
}
...
fn wellsfargo_flow_not_supported(flow: &str) -> Report<IntegrationError> {
...
fn wellsfargo_not_implemented(flow: &str) -> Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for wellsfargo"
    )))
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("create_order"))
    }
}
    ...
    for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_flow_not_supported("accept_dispute"))
    }
}
    ...
    > for Wellsfargo<T>
{
    fn get_url(
        ...
        Err(wellsfargo_not_implemented("repeat_payment"))
    }
}
