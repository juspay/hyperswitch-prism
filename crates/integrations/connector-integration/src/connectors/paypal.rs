...
use crate::{
    connectors::paypal::transformers::{
        ...
        PaypalClientAuthTokenResponse, PaypalIncrementalAuthRequest, PaypalIncrementalAuthResponse,
        PaypalOrderCreateRequest, PaypalOrderCreateResponse, PaypalPaymentsCancelResponse,
