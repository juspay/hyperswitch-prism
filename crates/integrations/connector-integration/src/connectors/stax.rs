...
fn stax_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("authenticate"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_not_implemented("create_client_authentication_token"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("create_order"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_not_implemented("create_server_authentication_token"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("void_post_capture"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_not_implemented("setup_mandate"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_not_implemented("repeat_payment"))
    }
}
    ...
    for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("accept_dispute"))
    }
}
    ...
    for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("submit_evidence"))
    }
}
    ...
    > for Stax<T>
{
    fn get_url(
        ...
        Err(stax_flow_not_supported("mandate_revoke"))
    }
}
