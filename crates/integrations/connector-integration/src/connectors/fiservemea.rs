...
use transformers::{
    ...
    FiservemeaRepeatPaymentResponse, FiservemeaSetupMandateRequest, FiservemeaSetupMandateResponse,
    FiservemeaSyncResponse, FiservemeaVoidResponse, PostAuthTransaction, ReturnTransaction,
    VoidTransaction,
};
...
// Repeat Payment (MIT) — Sale with storedCredentials referencing the CIT schemeTransactionId
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Fiservemea,
