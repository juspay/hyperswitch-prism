...
fn fiservemea_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn fiservemea_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for fiservemea"
    )))
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("void_post_capture"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("setup_mandate"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("repeat_payment"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_flow_not_supported("create_order"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented(
    ...
    for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_flow_not_supported("accept_dispute"))
    }
}
    ...
    for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_flow_not_supported("submit_evidence"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("payment_method_token"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("mandate_revoke"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("authenticate"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_not_implemented("post_authenticate"))
    }
}
    ...
    > for Fiservemea<T>
{
    fn get_url(
        ...
        Err(fiservemea_flow_not_supported("create_connector_customer"))
    }
}
