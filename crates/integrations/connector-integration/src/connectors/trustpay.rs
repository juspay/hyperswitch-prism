...
fn trustpay_flow_not_supported(flow: &str) -> Report<IntegrationError> {
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("create_connector_customer"))
    }
}
    ...
    for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("accept_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("submit_evidence"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("defend_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("void"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("void_post_capture"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("capture"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("payment_method_token"))
    }
}
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("authenticate"))
    }
}
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Trustpay<T>
{
    fn get_url(
        ...
        Err(trustpay_flow_not_supported("mandate_revoke"))
    }
}
