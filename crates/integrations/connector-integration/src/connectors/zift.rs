...
fn zift_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("incremental_authorization"))
    }
}
    ...
    ConnectorIntegrationV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData> for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("refund_sync"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("void_post_capture"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_flow_not_supported("create_order"))
    }
}
    ...
    for Zift<T>
{
    fn get_url(
        ...
        Err(zift_flow_not_supported("accept_dispute"))
    }
}
    ...
    for Zift<T>
{
    fn get_url(
        ...
        Err(zift_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Zift<T>
{
    fn get_url(
        ...
        Err(zift_flow_not_supported("submit_evidence"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("create_server_authentication_token"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("authenticate"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("post_authenticate"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("mandate_revoke"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("create_client_authentication_token"))
    }
}
    ...
    > for Zift<T>
{
    fn get_url(
        ...
        Err(zift_not_implemented("payment_method_token"))
    }
}
