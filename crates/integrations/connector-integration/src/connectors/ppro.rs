...
fn ppro_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn ppro_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_flow_not_supported("void_post_capture"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("create_order"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("create_client_authentication_token"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("create_server_authentication_token"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("payment_method_token"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("mandate_revoke"))
    }
}
    ...
    for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("accept_dispute"))
    }
}
    ...
    for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("submit_evidence"))
    }
}
    ...
    for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("defend_dispute"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("authenticate"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_not_implemented("post_authenticate"))
    }
}
    ...
    > for Ppro<T>
{
    fn get_url(
        ...
        Err(ppro_flow_not_supported("incremental_authorization"))
    }
}
