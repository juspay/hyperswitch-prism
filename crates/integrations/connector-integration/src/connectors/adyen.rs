...
fn adyen_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("void_post_capture"))
    }
}
    ...
    for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("refund_sync"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_flow_not_supported("server_authentication_token"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("authenticate"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("post_authenticate"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("mandate_revoke"))
    }
}
    ...
    > for Adyen<T>
{
    fn get_url(
        ...
        Err(adyen_not_implemented("payment_method_token"))
    }
}
