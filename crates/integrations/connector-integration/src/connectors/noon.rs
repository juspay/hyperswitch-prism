...
fn noon_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("create_order"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("accept_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("submit_evidence"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("defend_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Noon<T>
{
    fn get_url(
        ...
        Err(noon_flow_not_supported("create_client_authentication_token"))
    }
}
