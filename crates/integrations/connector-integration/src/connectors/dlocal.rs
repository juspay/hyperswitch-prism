...
fn dlocal_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("void_post_capture"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("create_order"))
    }
}
    ...
    for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_not_implemented("submit_evidence"))
    }
}
    ...
    for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_not_implemented("defend_dispute"))
    }
}
    ...
    for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("accept_dispute"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_not_implemented("payment_method_token"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("authenticate"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_not_implemented("create_client_authentication_token"))
    }
}
    ...
    > for Dlocal<T>
{
    fn get_url(
        ...
        Err(dlocal_not_implemented("mandate_revoke"))
    }
}
