...
fn novalnet_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn novalnet_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for novalnet"
    )))
}
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("void_post_capture"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("create_order"))
    }
}
    ...
    for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("accept_dispute"))
    }
}
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported(
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("create_connector_customer"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_not_implemented("payment_method_token"))
    }
}
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("authenticate"))
    }
}
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Novalnet<T>
{
    fn get_url(
        ...
        Err(novalnet_not_implemented("mandate_revoke"))
    }
}
