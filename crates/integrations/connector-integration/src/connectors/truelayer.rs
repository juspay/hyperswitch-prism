...
fn truelayer_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn truelayer_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for truelayer"
    )))
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("void_post_capture"))
    }
}
    ...
    for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_not_implemented("void"))
    }
}
    ...
    for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("capture"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("create_order"))
    }
}
    ...
    for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("accept_dispute"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_not_implemented("setup_mandate"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_not_implemented("repeat_payment"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_flow_not_supported("payment_method_token"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_not_implemented("authenticate"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_not_implemented("post_authenticate"))
    }
}
    ...
    > for Truelayer<T>
{
    fn get_url(
        ...
        Err(truelayer_not_implemented("mandate_revoke"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
