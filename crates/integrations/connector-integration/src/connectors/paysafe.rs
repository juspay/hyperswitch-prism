...
fn paysafe_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn paysafe_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for paysafe"
    )))
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("mandate_revoke"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("authenticate"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("create_order"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("setup_mandate"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("void_post_capture"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("post_authenticate"))
    }
}
    ...
    for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_flow_not_supported("dispute_accept"))
    }
}
    ...
    for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_flow_not_supported("dispute_defend"))
    }
}
    ...
    for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_flow_not_supported("dispute_submit_evidence"))
    }
}
    ...
    > for Paysafe<T>
{
    fn get_url(
        ...
        Err(paysafe_not_implemented("create_connector_customer"))
    }
}
