...
fn payload_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("create_order"))
    }
}
    ...
    for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("accept_dispute"))
    }
}
    ...
    > for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("mandate_revoke"))
    }
}
    ...
    > for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("post_authenticate"))
    }
}
    ...
    > for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("authenticate"))
    }
}
    ...
    > for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("pre_authenticate"))
    }
}
    ...
    > for Payload<T>
{
    fn get_url(
        ...
        Err(payload_flow_not_supported("void_post_capture"))
    }
}
