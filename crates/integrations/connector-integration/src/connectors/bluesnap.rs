...
fn bluesnap_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn bluesnap_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for bluesnap"
    )))
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_flow_not_supported("void_post_capture"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("setup_mandate"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("repeat_payment"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("mandate_revoke"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_flow_not_supported("create_order"))
    }
}
    ...
    for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_flow_not_supported("accept_dispute"))
    }
}
    ...
    for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_flow_not_supported("submit_evidence"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("payment_method_token"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_flow_not_supported("server_authentication_token"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("authenticate"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("post_authenticate"))
    }
}
    ...
    > for Bluesnap<T>
{
    fn get_url(
        ...
        Err(bluesnap_not_implemented("create_connector_customer"))
    }
}
