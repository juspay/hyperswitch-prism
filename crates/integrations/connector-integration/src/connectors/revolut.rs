...
fn revolut_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn revolut_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for revolut"
    )))
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("create_order"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("authenticate"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("post_authenticate"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("create_connector_customer"))
    }
}
    ...
    for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("defend_dispute"))
    }
}
    ...
    for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("accept_dispute"))
    }
}
    ...
    for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("submit_evidence"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_flow_not_supported("reverse"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("setup_mandate"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("repeat_payment"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("mandate_revoke"))
    }
}
    ...
    > for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_flow_not_supported("tokenize"))
    }
}
    ...
    for Revolut<T>
{
    fn get_url(
        ...
        Err(revolut_not_implemented("void"))
    }
}
