...
fn cybersource_flow_not_supported(flow: &str) -> Report<IntegrationError> {
    ...
    > for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_not_implemented("incremental_authorization"))
    }
}
    ...
    > for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_not_implemented("void_post_capture"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    > for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_not_implemented("create_order"))
    }
}
    ...
    for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_flow_not_supported("accept_dispute"))
    }
}
    ...
    > for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_not_implemented(
    ...
    > for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_not_implemented("payment_method_token"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Cybersource<T>
{
    fn get_url(
        ...
        Err(cybersource_not_implemented("create_connector_customer"))
    }
}
