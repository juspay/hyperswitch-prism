...
fn redsys_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn redsys_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for redsys"
    )))
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("client_authentication_token"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("server_authentication_token"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("create_order"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_not_implemented("setup_mandate"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_not_implemented("void_post_capture"))
    }
}
    ...
    for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("accept_dispute"))
    }
}
    ...
    for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("submit_evidence"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_not_implemented("post_authenticate"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_not_implemented("repeat_payment"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_not_implemented("payment_method_token"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_flow_not_supported("mandate_revoke"))
    }
}
    ...
    > for Redsys<T>
{
    fn get_url(
        ...
        Err(redsys_not_implemented("incremental_authorization"))
    }
}
