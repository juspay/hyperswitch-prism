...
fn bamboraapac_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn bamboraapac_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for bamboraapac"
    )))
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("authenticate"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("post_authenticate"))
    }
}
    ...
    for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_flow_not_supported("accept_dispute"))
    }
}
    ...
    for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_flow_not_supported("defend_dispute"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("mandate_revoke"))
    }
}
    ...
    for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("void"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("void_post_capture"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("payment_method_token"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("create_connector_customer"))
    }
}
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented(
    ...
    > for Bamboraapac<T>
{
    fn get_url(
        ...
        Err(bamboraapac_not_implemented("create_order"))
    }
}
