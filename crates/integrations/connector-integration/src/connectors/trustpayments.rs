    ...
    > for Trustpayments<T>
{
    fn get_url(
        ...
        Err(trustpayments_flow_not_supported("client_authentication_token"))
    }
}
    ...
    > for Trustpayments<T>
{
    fn get_url(
        ...
        Err(trustpayments_flow_not_supported("server_authentication_token"))
    }
}
    ...
    > for Trustpayments<T>
{
    fn get_url(
        ...
        Err(trustpayments_flow_not_supported("create_connector_customer"))
    }
}
