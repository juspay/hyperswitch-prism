...
mod tests {
    ...
    // Regression for #23167/#23168/#23169/#23170: Adyen's SetupMandate previously only handled
    // PaymentMethodData::Card, and returned NotImplemented("payment method") for every other
    // variant -- including decrypted Apple Pay / Google Pay wallets, which HS's own Adyen
    // connector accepts by reusing its Authorize builder. build_request_v2 must now succeed
    // instead of erroring.
    pub mod setup_mandate {
        ...
        use domain_types::{
            ...
            payment_method_data::{
                ...
                GpayEncryptedTokenizationData, GpayTokenizationData, PaymentMethodData, WalletData,
            },
            router_data::{ConnectorSpecificConfig, ErrorResponse},
            router_data_v2::RouterDataV2,
            types::{ConnectorParams, Connectors},
        ...
        #[test]
        fn test_setup_mandate_google_pay_wallet_is_implemented() {
            let req: RouterDataV2<
                SetupMandate,
                PaymentFlowData,
            ...
            > = RouterDataV2 {
                ...
                resource_common_data: PaymentFlowData {
                    ...
                    customer_id: None,
                    connector_customer: None,
                    payment_id: "pay_setup_mandate_gpay".to_string(),
                    attempt_id: "attempt_setup_mandate_gpay".to_string(),
                    status: common_enums::AttemptStatus::Pending,
                    payment_method: common_enums::PaymentMethod::Wallet,
                    payment_method_type: Some(common_enums::PaymentMethodType::GooglePay),
                    description: None,
                    return_url: Some("www.google.com".to_string()),
                    order_details: None,
                    address: domain_types::payment_address::PaymentAddress::new(
                    ...
                    preprocessing_id: None,
                    connector_api_version: None,
                    connector_request_reference_id: "conn_ref_setup_mandate_gpay".to_string(),
                    test_mode: None,
                    connector_http_status_code: None,
                    connectors: Connectors {
                        adyen: ConnectorParams {
                ...
                connector_config: ConnectorSpecificConfig::Adyen {
                    ...
                    merchant_account: Secret::new("test_adyen_key1".to_string()),
                    review_key: None,
                    base_url: None,
                    dispute_base_url: None,
                    endpoint_prefix: None,
                ...
                request: SetupMandateRequestData {
                    currency: common_enums::Currency::USD,
                    payment_method_data: PaymentMethodData::Wallet(WalletData::GooglePay(
                        GooglePayWalletData {
                            pm_type: "CARD".to_string(),
                            description: "Google Pay".to_string(),
                            ...
                            tokenization_data: GpayTokenizationData::Encrypted(
                                GpayEncryptedTokenizationData {
                                    token_type: "PaymentGateway".to_string(),
                                    token: "encrypted_gpay_token".to_string(),
                                },
                            ),
                        },
                    )),
                    ...
                    shipping_cost: None,
                    customer_id: Some(
                        common_utils::id_type::CustomerId::try_from(std::borrow::Cow::from(
                            "cus_setup_mandate_gpay".to_string(),
                        ))
                        .unwrap(),
                    ),
                    integrity_object: None,
            ...
            assert!(
                result.is_ok(),
                "Expected Google Pay wallet to be implemented for SetupMandate, got: {result:?}"
            );
        }
    }
}
