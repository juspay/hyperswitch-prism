...
use domain_types::{
    ...
    connector_types::{
        ...
        AdyenSplitRefundData, CardDetailUpdate, ClientAuthenticationTokenData,
        ...
        PaymentMethodUpdate, PaymentVoidData, PaymentsAuthorizeData, PaymentsCancelPostCaptureData,
        ...
        ResponseId, SetupMandateRequestData, SplitRefundsRequest, SubmitEvidenceData,
    },
