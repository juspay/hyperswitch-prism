...
// SetupMandate Flow (Zero-Dollar Auth for Credential-on-File)
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Bambora,
...
// RepeatPayment Flow (Merchant Initiated Transaction)
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Bambora,
...
// SetupMandate and RepeatPayment ConnectorIntegrationV2 impls are generated by
// macro_connector_implementation! below
