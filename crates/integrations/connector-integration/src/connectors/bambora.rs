    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("void_post_capture"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("setup_mandate"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("repeat_payment"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("create_order"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("payment_method_token"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("authenticate"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("post_authenticate"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("create_connector_customer"))
    }
}
    ...
    > for Bambora<T>
{
    fn get_url(
        ...
        Err(bambora_not_implemented("mandate_revoke"))
    }
}
