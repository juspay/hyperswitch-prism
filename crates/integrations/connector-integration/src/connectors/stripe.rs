...
fn stripe_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn stripe_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    error_stack::report!(IntegrationError::not_implemented(format!(
        "{flow} flow for stripe"
    )))
}
    ...
    > for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_flow_not_supported("void_post_capture"))
    }
}
    ...
    > for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_flow_not_supported("mandate_revoke"))
    }
}
    ...
    for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_not_implemented("accept_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_not_implemented("submit_evidence"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ...
    for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_not_implemented("defend_dispute"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_flow_not_supported("create_order"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_flow_not_supported("server_authentication_token"))
    }
}
    ...
    > for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_not_implemented("authenticate"))
    }
}
    ...
    > for Stripe<T>
{
    fn get_url(
        ...
        Err(stripe_not_implemented("post_authenticate"))
    }
}
