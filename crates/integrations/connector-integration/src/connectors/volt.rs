...
fn volt_flow_not_supported(flow: &str) -> error_stack::Report<IntegrationError> {
...
fn volt_not_implemented(flow: &str) -> error_stack::Report<IntegrationError> {
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("incremental_authorization"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("void_post_capture"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("create_client_authentication_token"))
    }
}
    ...
    for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("capture"))
    }
}
    ...
    ConnectorIntegrationV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData> for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("refund_sync"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("create_order"))
    }
}
    ...
    for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("submit_evidence"))
    }
}
    ...
    for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("defend_dispute"))
    }
}
    ...
    for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("accept_dispute"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("setup_mandate"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("repeat_payment"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_flow_not_supported("create_connector_customer"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("payment_method_token"))
    }
}
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    ConnectorIntegrationV2<
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("pre_authenticate"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("authenticate"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("post_authenticate"))
    }
}
    ...
    > for Volt<T>
{
    fn get_url(
        ...
        Err(volt_not_implemented("mandate_revoke"))
    }
}
