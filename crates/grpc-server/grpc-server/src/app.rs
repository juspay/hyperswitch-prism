...
use grpc_api_types::{
    ...
    payments::{
        ...
        connector_capability_service_server, customer_service_server, dispute_service_server,
...
pub struct Service {
    ...
    pub connector_capability_service: crate::server::feature_matrix::ConnectorCapability,
...
impl Service {
    ...
    pub async fn new(config: Arc<configs::Config>) -> Self {
        ...
        Self {
            ...
            connector_capability_service: crate::server::feature_matrix::ConnectorCapability,
    ...
    pub async fn grpc_server(
        ...
        Server::builder()
            ...
            .add_service(
                connector_capability_service_server::ConnectorCapabilityServiceServer::new(
                    self.connector_capability_service,
                ),
            )
