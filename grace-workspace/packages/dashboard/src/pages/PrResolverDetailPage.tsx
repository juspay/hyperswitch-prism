  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <PanelCard>
        ...
        <Field label="Source">
          {source === "extracted"
            ? "Extracted from PR body's `## Testing` section"
            : source === "generated"
              ? "Generated by Claude (no Testing section found)"
              : "None — step was skipped"}
        </Field>
        <Field label="Commands">{commands.length || "(none)"}</Field>
      </PanelCard>
      {commands.length > 0 && (
        <PanelCard>
          <h3 style={{ ...subTitle, margin: "0 0 8px" }}>Commands</h3>
