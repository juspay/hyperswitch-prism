# Connector `stripe` / Suite `EventService/HandleEvent`
...
- [`Handle Event | Payment Succeeded`](./eventservice-handleevent/payment-succeeded.md) — Resolved method descriptor:
- [`Handle Event | Refund Succeeded`](./eventservice-handleevent/refund-succeeded.md) — Resolved method descriptor:
