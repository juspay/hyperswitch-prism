# Connector `rapyd` / Suite `MerchantAuthenticationService/CreateClientAuthenticationToken` / Scenario `Create SDK Session Token | Create SDK Session Apple Pay`
...
{
  "merchant_client_session_id": "gen_419493",
  "payment": {
    "amount": {
      "minor_amount": 10000,
      "currency": "USD"
    ...
    "customer": {
      "id": "cust_e5544ad050ca4468a03b15ef",
      "name": "Ethan Miller",
      "email": {
        "value": "morgan.5422@testmail.io"
      }
    }
  }
}
...
Response contents:
{
  "sessionData": {
    "connectorSpecific": {
      "rapyd": {
        "checkoutId": "checkout_fe2bbc43b3e0e5a47f0500369f55e96d",
        "redirectUrl": "https://sandboxcheckout.rapyd.net/?token=checkout_fe2bbc43b3e0e5a47f0500369f55e96d"
      }
    }
  },
  "statusCode": 200,
