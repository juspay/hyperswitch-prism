# Connector `paypal` / Suite `EventService/HandleEvent`
...
| [`Handle Event \| Payment Succeeded`](./eventservice-handleevent/payment-succeeded.md) | - | - | `PASS` | None |
| [`Handle Event \| Refund Succeeded`](./eventservice-handleevent/refund-succeeded.md) | - | - | `PASS` | None |
