# Connector `authorizedotnet` / Suite `EventService/HandleEvent` / Scenario `Handle Event | Invalid Signature Test`
  ...
  -d @ localhost:8000 types.EventService/HandleEvent <<'JSON'
{
  "request_details": {
    ...
    "headers": {
      "X-ANET-Signature": ***MASKED***"
    },
    "body": "eyJub3RpZmljYXRpb25JZCI6ImludmFsaWQiLCJldmVudFR5cGUiOiJuZXQuYXV0aG9yaXplLnBheW1lbnQuYXV0aGNhcHR1cmUuY3JlYXRlZCIsInBheWxvYWQiOnsicmVzcG9uc2VDb2RlIjoxLCJpZCI6ImludmFsaWQifX0="
  },
