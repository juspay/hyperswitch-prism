# Connector `adyen` / Suite `EventService/HandleEvent` / Scenario `Handle Event | Invalid Signature Test`
  ...
  -d @ localhost:8000 types.EventService/HandleEvent <<'JSON'
{
  "request_details": {
    ...
    "headers": {},
    "body": ""
  },
