# Connector `nuvei` / Suite `MerchantAuthenticationService/CreateServerSessionAuthenticationToken` / Scenario `Create Session Token | Create Session Basic`
...
{
  "test_mode": true,
  "merchant_server_session_id": "gen_610593",
  "payment": {
    "amount": {
      "minor_amount": 10000,
      "currency": "USD"
