# Connector `nuvei` / Suite `MerchantAuthenticationService/CreateClientAuthenticationToken` / Scenario `Create SDK Session Token | Create SDK Session Apple Pay`
...
{
  "merchant_client_session_id": "gen_364480",
  "payment": {
    "amount": {
      "minor_amount": 10000,
      "currency": "USD"
    ...
    "customer": {
      "id": "cust_83774c89ddbb42568779f9a5",
      "name": "Mia Wilson",
      "email": {
        "value": "alex.9184@testmail.io"
      }
    }
  }
}
...
Response contents:
{
  "sessionData": {
    "connectorSpecific": {
      "nuvei": {
        "sessionToken": ***MASKED***
          "value": "1e212735270141baa51ff34a961b53620121"
        }
      }
    }
  },
