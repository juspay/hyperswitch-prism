# Connector `nuvei` / Suite `PaymentService/Authorize` / Scenario `BACS Bank Transfer | No 3DS | Automatic Capture`
...
{
  "test_mode": true,
  "merchant_server_session_id": "gen_462775",
  "payment": {
    "amount": {
      "minor_amount": 10000,
      "currency": "USD"
...
{
  "merchant_transaction_id": "mti_ad99011217a64069894cf18a",
  "amount": {
    "minor_amount": 10000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Brown",
    "email": {
      "value": "sam.2673@testmail.io"
    },
    "id": "cust_6b1d9d1ad9c14f67ab6517d3",
    "phone_number": "+915433117456"
  },
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "7663 Market Rd"
      },
      "line3": {
        "value": "3993 Market Blvd"
      },
      "city": {
        "value": "New York"
      },
