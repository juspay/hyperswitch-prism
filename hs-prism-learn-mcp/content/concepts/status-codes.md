---
{
  ...
  "depth": {
    ...
    "deep": "The numeric mappings are derived from payment.proto and mirrored in integration-mcp/src/status/statusMap.ts. Connectors map a processor's status strings to these numbers via From/TryFrom, never hardcoding outside match arms. See error-model and error-handling.md."
  },
  "prerequisites": ["flow"],
  ...
  "go_deeper": [
    ...
    {"path": "integration-mcp/src/status/statusMap.ts", "why": "the numeric status code semantics, in code"}
  ],
  "verify_anchors": [
    {"path": "integration-mcp/src/status/statusMap.ts", "must_contain": "CHARGED"}
  ]
}
---
