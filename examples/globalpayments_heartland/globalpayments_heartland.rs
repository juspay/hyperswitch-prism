...
//
// Globalpayments_Heartland — all scenarios and flows in one file.
...
#[allow(dead_code)]
pub const SUPPORTED_FLOWS: &[&str] = &["authorize", "capture", "get", "proxy_authorize", "refund", "refund_get", "void"];
