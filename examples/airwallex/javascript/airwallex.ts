...
// Run a scenario:  npx ts-node airwallex.ts checkout_card
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, capture, createAccessToken, createOrder, get, refund, voidPayment, _buildCreateAccessTokenRequest };
