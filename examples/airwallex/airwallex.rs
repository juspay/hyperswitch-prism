...
pub fn build_handle_event_request() -> EventServiceHandleRequest {
    EventServiceHandleRequest {
        ...
        request_details: Some(RequestDetails {
            ...
            body: "{\"id\":\"evt_100_24e503a6-a5cf-4247-8dc3-8d9a4f8bbf7a\",\"name\":\"payment_intent.succeeded\",\"account_id\":\"acst_1a2b3c4d5e6f7788\",\"org_id\":\"org_prod_AUD_emh5hvn0tbljdi6qt\",\"data\":{\"object\":{\"id\":\"int_1a2b3c4d5e6f7788\",\"merchant_order_id\":\"order_1234\",\"status\":\"SUCCEEDED\",\"amount\":49.12,\"currency\":\"HKD\",\"captured_amount\":49.12}},\"created_at\":\"2024-05-06T07:31:29.226+0000\"}".as_bytes().to_vec(),  // Body of the HTTP request.
            ..Default::default()
        }),
        ..Default::default()
    }
...
pub fn build_pre_authenticate_request() -> PaymentMethodAuthenticationServicePreAuthenticateRequest
{
    PaymentMethodAuthenticationServicePreAuthenticateRequest {
        ...
        connector_order_id: Some("connector_order_id".to_string()), // Send the connector order identifier here if an order was created before pre-authentication. Elavon PG's hosted-payment-page 3DS needs the Order resource URL returned by PaymentService/CreateOrder to open a payment session.
        ..Default::default()
    }
}
...
async fn main() {
    ...
    let result: Result<String, Box<dyn std::error::Error>> = match flow.as_str() {
        ...
        _ => {
            eprintln!("Unknown flow: {}. Available: process_checkout_autocapture, process_checkout_card, process_refund, process_void_payment, process_get_payment, process_authorize, process_capture, process_create_order, process_create_server_authentication_token, process_get, process_parse_event, process_pre_authenticate, process_proxy_authorize, process_refund_get, process_void", flow);
            return;
        }
    };
    match result {
