...
import { PaymentClient, MerchantAuthenticationClient, CustomerClient, EventClient, PaymentMethodAuthenticationClient, RecurringPaymentClient, RefundClient, types } from 'hyperswitch-prism';
...
export const SUPPORTED_FLOWS = ["authorize", "capture", "create_client_authentication_token", "customer_create", "get", "incremental_authorization", "parse_event", "pre_authenticate", "proxy_authorize", "proxy_setup_recurring", "recurring_charge", "refund", "refund_get", "setup_recurring", "token_authorize", "token_setup_recurring", "void"];
...
function _buildHandleEventRequest(): types.IEventServiceHandleRequest {
    return {
        ...
        "requestDetails": {
            ...
            "body": new Uint8Array(Buffer.from("{\"id\":\"evt_probe_001\",\"type\":\"CHARGE_SUCCEEDED\",\"data\":{\"id\":\"char_ORVCrwOrTkGsDwM3H50OIW7Q\",\"objectType\":\"charge\",\"status\":\"successful\",\"captured\":true,\"refunded\":false,\"refunds\":[]}}", "utf-8"))  // Body of the HTTP request.
        }
    };
}
