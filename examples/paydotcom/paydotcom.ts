...
export const SUPPORTED_FLOWS = ["authorize", "capture", "get", "pre_authenticate", "proxy_authorize", "refund", "refund_get", "void"];
...
async function capture(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig) {
    ...
    const captureResponse = await paymentClient.capture(_buildCaptureRequest('hld_146231656762572800'));
...
async function get(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig) {
    ...
    const getResponse = await paymentClient.get(_buildGetRequest('chrg_146231656762572800'));
...
async function refund(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig) {
    ...
    const refundResponse = await paymentClient.refund(_buildRefundRequest('chrg_146231656762572800'));
...
async function voidPayment(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig) {
    ...
    const voidResponse = await paymentClient.void(_buildVoidRequest('hld_146231656762572800'));
...
export {
    processCheckoutAutocapture, processCheckoutCard, processRefund, processVoidPayment, processGetPayment, authorize, capture, get, preAuthenticate, proxyAuthorize, refund, refundGet, voidPayment, _buildAuthorizeRequest, _buildCaptureRequest, _buildGetRequest, _buildPreAuthenticateRequest, _buildProxyAuthorizeRequest, _buildRefundRequest, _buildRefundGetRequest, _buildVoidRequest
};
