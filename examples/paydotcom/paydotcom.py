...
# Run a scenario:  python3 paydotcom.py checkout_card
...
SUPPORTED_FLOWS = ["authorize", "capture", "get", "pre_authenticate", "proxy_authorize", "proxy_setup_recurring", "refund", "refund_get", "setup_recurring", "void"]
...
async def process_capture(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    capture_response = await payment_client.capture(_build_capture_request("hld_146231656762572800"))
...
async def process_get(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    get_response = await payment_client.get(_build_get_request("chrg_146231656762572800"))
...
async def process_void(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    void_response = await payment_client.void(_build_void_request("hld_146231656762572800"))
