    ...
    let response = client
        .parse_event(
            TODO_FIX_MISSING_TYPE_parse_event {
                // request_details: {"method": "HTTP_METHOD_POST", "uri": "https://example.com/webhook", "headers": {}, "body": "{\"eventType\":\"net.authorize.payment.authcapture.created\",\"payload\":{\"id\":\"probe_txn_001\",\"responseCode\":1,\"authCode\":\"probe_auth\"}}"}
                ..Default::default()
            },
            &HashMap::new(),
            None,
    ...
    let response = client
        .proxy_setup_recurring(
            TODO_FIX_MISSING_TYPE_proxy_setup_recurring {
                ...
                // card_proxy: {"card_number": "4111111111111111", "card_exp_month": "03", "card_exp_year": "2030", "card_cvc": "123", "card_holder_name": "John Doe"}
                // customer: {"connector_customer_id": "cust_probe_123"}
                // address: {"billing_address": {}}
