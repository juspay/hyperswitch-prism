...
// Run a scenario:  npx ts-node razorpay.ts checkout_card
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processGetPayment, authorize, capture, createOrder, get, refund };
