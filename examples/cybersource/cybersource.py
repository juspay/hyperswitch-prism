...
async def process_authenticate(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    authenticate_response = await payment_client.authenticate(payment_pb2.TODO_FIX_MISSING_TYPE_authenticate(
        minor_amount=1000,
        currency="USD",
        card_number="4111111111111111",
        card_exp_month="03",
...
async def process_post_authenticate(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    post_authenticate_response = await payment_client.post_authenticate(payment_pb2.TODO_FIX_MISSING_TYPE_post_authenticate(
        minor_amount=1000,
        currency="USD",
        card_number="4111111111111111",
        card_exp_month="03",
...
async def process_recurring_revoke(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    recurring_response = await payment_client.recurring_revoke(payment_pb2.TODO_FIX_MISSING_TYPE_recurring_revoke(
