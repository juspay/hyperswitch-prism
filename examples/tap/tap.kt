...
// Run a scenario:  ./gradlew run --args="tap processCheckoutCard"

package examples.tap
...
import types.Payment.TapConfig
...
fun handleEvent(txnId: String, config: ConnectorConfig = _defaultConfig) {
    ...
    val request = EventServiceHandleRequest.newBuilder().apply {
        ...
        requestDetailsBuilder.apply {
            ...
            body = com.google.protobuf.ByteString.copyFromUtf8("{\"id\":\"chg_probe_001\",\"object\":\"charge\",\"status\":\"CAPTURED\",\"reference\":{\"transaction\":\"probe_txn_001\"},\"response\":{\"code\":\"000\",\"message\":\"Captured\"}}")  // Body of the HTTP request.
        }
    }.build()
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, capture, get, handleEvent, parseEvent, refund, refundGet, void")
    }
}
