...
// Regenerate: python3 scripts/generate-connector-docs.py tap
//
// Tap — all scenarios and flows in one file.
// Run a scenario:  cargo run --example tap -- process_checkout_card
        ...
        payment_method: Some(PaymentMethod {
            ...
            payment_method: Some(payment_method::PaymentMethod::GooglePaySdk(GoogleWallet {
                ...
                tokenization_data: Some(TokenizationData {
                    encrypted_data: Some(GooglePayEncryptedTokenizationData {
                        ...
                        token: "{\"id\":\"tok_probe_gpay\",\"object\":\"token\",\"type\":\"card\"}"
                            .to_string(), // Token generated for the wallet.
                    }),
                }),
            })),
            ..Default::default()
...
pub fn build_handle_event_request() -> EventServiceHandleRequest {
    EventServiceHandleRequest {
        ...
        request_details: Some(RequestDetails {
            ...
            body: "{\"id\":\"chg_probe_001\",\"object\":\"charge\",\"status\":\"CAPTURED\",\"reference\":{\"transaction\":\"probe_txn_001\"},\"response\":{\"code\":\"000\",\"message\":\"Captured\"}}".as_bytes().to_vec(),  // Body of the HTTP request.
            ..Default::default()
        }),
        ..Default::default()
    }
...
async fn main() {
    ...
    let result: Result<String, Box<dyn std::error::Error>> = match flow.as_str() {
        ...
        _ => {
            eprintln!("Unknown flow: {}. Available: process_checkout_autocapture, process_refund, process_void_payment, process_get_payment, process_authorize, process_capture, process_get, process_parse_event, process_refund_get, process_void", flow);
            return;
        }
    };
    match result {
