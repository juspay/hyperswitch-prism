    ...
    let authorize_response = client
        .authorize(
            TODO_FIX_MISSING_TYPE_authorize {
                ...
                order_category: "mobile".to_string(),
    ...
    let response = client
        .parse_event(
            TODO_FIX_MISSING_TYPE_parse_event {
                // request_details: {"method": "HTTP_METHOD_POST", "uri": "https://example.com/webhook", "headers": {}, "body": "{\"orderId\":12345,\"orderStatus\":\"CAPTURED\",\"eventType\":\"SALE\",\"eventId\":\"probe-event-001\",\"timeStamp\":\"2024-01-01T00:00:00Z\"}"}
                ..Default::default()
            },
            &HashMap::new(),
            None,
...
pub async fn process_recurring_revoke(
    ...
    let response = client
        .recurring_revoke(
            TODO_FIX_MISSING_TYPE_recurring_revoke {
                merchant_revoke_id: "probe_revoke_001".to_string(),
                mandate_id: "probe_mandate_001".to_string(),
                connector_mandate_id: "probe_connector_mandate_001".to_string(),
                ..Default::default()
            },
            &HashMap::new(),
            None,
