...
def _build_parse_event_request():
    return payment_pb2.EventServiceParseRequest(
        request_details=payment_pb2.RequestDetails(
            ...
            body="{\"orderId\":12345,\"orderStatus\":\"CAPTURED\",\"eventType\":\"SALE\",\"eventId\":\"probe-event-001\",\"timeStamp\":\"2024-01-01T00:00:00Z\"}".encode(),  # Body of the HTTP request.
        ),
    )
...
def _build_proxy_setup_recurring_request():
    return payment_pb2.PaymentServiceProxySetupRecurringRequest(
        ...
        metadata=payment_methods_pb2.SecretString(value="{\"order_category\":\"mobile\",\"description\":\"purchase desc\"}"),
