...
// Run a scenario:  ./gradlew run --args="juspay processCheckoutCard"
...
import types.Payment.JuspayConfig
...
private fun buildAuthorizeRequest(captureMethodStr: String): PaymentServiceAuthorizeRequest {
    return PaymentServiceAuthorizeRequest.newBuilder().apply {
        ...
        paymentMethodBuilder.apply {  // Payment method to be used.
            googlePaySdkBuilder.apply {  // Google Pay.
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, capture, createOrder, get, proxyAuthorize, refund, refundGet, void")
    }
}
