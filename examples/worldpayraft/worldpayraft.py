...
# Run a scenario:  python3 worldpayraft.py checkout_card
...
SUPPORTED_FLOWS = ["authorize", "capture", "parse_event", "proxy_authorize", "proxy_setup_recurring", "recurring_charge", "refund", "setup_recurring", "void"]
...
def _build_authorize_request(capture_method: str):
    return payment_pb2.PaymentServiceAuthorizeRequest(
        ...
        address=payment_pb2.PaymentAddress(  # Address Information.
            shipping_address=payment_pb2.Address(
                line1=payment_methods_pb2.SecretString(value="500 Elm St"),  # Address Details.
                city=payment_methods_pb2.SecretString(value="Dayton"),
                state=payment_methods_pb2.SecretString(value="OH"),
                zip_code=payment_methods_pb2.SecretString(value="45402"),
            ),
            billing_address=payment_pb2.Address(
                first_name=payment_methods_pb2.SecretString(value="Jane"),  # Personal Information.
                ...
                city=payment_methods_pb2.SecretString(value="Cincinnati"),
                state=payment_methods_pb2.SecretString(value="OH"),
                zip_code=payment_methods_pb2.SecretString(value="45201"),
            ),
        ),
        auth_type=payment_pb2.AuthenticationType.Value("NO_THREE_DS"),  # Authentication Details.
        return_url="https://example.com/return",  # URLs for Redirection and Webhooks.
        billing_descriptor=payment_pb2.BillingDescriptor(  # Statement Descriptor.
            name=payment_methods_pb2.SecretString(value="ACME WIDGETS"),  # Customer's billing name.
            city=payment_methods_pb2.SecretString(value="CINCINNATI"),  # Customer's billing city.
        ),
        l2_l3_data=payment_pb2.L2L3Data(  # Level 2 / Level 3 data for enhanced payment processing.
            order_info=payment_pb2.OrderInfo(  # Order-level information.
    ...
    return payment_pb2.RecurringPaymentServiceChargeRequest(
        connector_recurring_payment_id=payment_pb2.MandateReference(  # Reference to existing mandate.
            connector_mandate_id=payment_pb2.ConnectorMandateReferenceId(  # mandate_id sent by the connector.
                ...
                mandate_metadata=payment_methods_pb2.SecretString(value="{\"expiration_date\":\"3012\"}"),
            ),
        ),
...
async def process_capture(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    capture_response = await payment_client.capture(_build_capture_request("0000000000000001"))
...
async def process_void(merchant_transaction_id: str, config: sdk_config_pb2.ConnectorConfig = _default_config):
    ...
    void_response = await payment_client.void(_build_void_request("0000000000000001"))
