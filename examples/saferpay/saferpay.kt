...
val SUPPORTED_FLOWS = listOf<String>("capture", "get", "parse_event", "pre_authenticate", "proxy_setup_recurring", "refund_get", "void")
...
fun handleEvent(txnId: String, config: ConnectorConfig = _defaultConfig) {
    ...
    val request = EventServiceHandleRequest.newBuilder().apply {
        ...
        requestDetailsBuilder.apply {
            ...
            body = com.google.protobuf.ByteString.copyFromUtf8("{\"id\":\"SaferpayTransactionIdplaceholder0\"}")  // Body of the HTTP request.
        }
    }.build()
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: capture, get, handleEvent, parseEvent, preAuthenticate, proxySetupRecurring, refundGet, void")
    }
}
