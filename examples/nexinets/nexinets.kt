...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "refund" -> refund(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processRefund, processGetPayment, authorize, get, proxyAuthorize, recurringCharge, refund")
    }
}
