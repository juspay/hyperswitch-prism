...
pub fn build_recurring_charge_request() -> RecurringPaymentServiceChargeRequest {
    ...
    "merchant_order_id": "probe_order_001",  // Optional fields.
...
pub fn build_setup_recurring_request() -> PaymentServiceSetupRecurringRequest {
    ...
    "merchant_order_id": "probe_order_001",  // Merchant's internal reference ID.
...
async fn main() {
    ...
    let result: Result<String, Box<dyn std::error::Error>> = match flow.as_str() {
        ...
        _ => { eprintln!("Unknown flow: {}. Available: process_checkout_autocapture, process_refund, process_get_payment, authorize, create_order, get, proxy_authorize, recurring_charge, refund, refund_get, setup_recurring, token_authorize", flow); return; }
    };
    match result {
        Ok(msg) => println!("✓ {msg}"),
        Err(e) => eprintln!("✗ {e}"),
