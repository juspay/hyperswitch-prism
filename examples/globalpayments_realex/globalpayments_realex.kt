...
//
// Globalpayments_Realex — all scenarios and flows in one file.
// Run a scenario:  ./gradlew run --args="globalpayments_realex processCheckoutCard"

package examples.globalpayments_realex
...
import types.Payment.GlobalpaymentsRealexConfig
import payments.SecretString

val SUPPORTED_FLOWS = listOf<String>("authorize", "capture", "get", "pre_authenticate", "proxy_authorize", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processCheckoutCard, processVoidPayment, processGetPayment, authorize, capture, get, preAuthenticate, proxyAuthorize, void")
    }
}
