...
// Run a scenario:  npx ts-node trustpay.ts checkout_autocapture
...
export { processCheckoutAutocapture, processRefund, processGetPayment, authorize, createAccessToken, createOrder, get, refund, _buildCreateAccessTokenRequest };
