...
val SUPPORTED_FLOWS = listOf<String>("authorize", "create_order", "create_server_authentication_token", "get", "proxy_authorize", "recurring_charge", "refund", "refund_get")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processRefund, processGetPayment, authorize, createOrder, createServerAuthenticationToken, get, handleEvent, proxyAuthorize, recurringCharge, refund, refundGet")
    }
}
