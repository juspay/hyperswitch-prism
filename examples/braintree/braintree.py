...
SUPPORTED_FLOWS = ["capture", "create_client_authentication_token", "get", "parse_event", "post_authenticate", "pre_authenticate", "proxy_setup_recurring", "refund", "reverse", "setup_recurring", "token_authorize", "void"]
