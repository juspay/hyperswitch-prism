...
const { Environment, AcceptanceType, AuthenticationType, Currency, FutureUsage } = types;
export const SUPPORTED_FLOWS = ["capture", "get", "pre_authenticate", "refund", "refund_get", "setup_recurring", "void"];
