...
val SUPPORTED_FLOWS = listOf<String>("authorize", "capture", "refund", "refund_get", "setup_recurring", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processCheckoutCard, processRefund, processVoidPayment, authorize, capture, refund, refundGet, setupRecurring, void")
    }
}
