...
// Run a scenario:  npx ts-node wellsfargo.ts checkout_card
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, capture, get, refund, setupRecurring, voidPayment };
