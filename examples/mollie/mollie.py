...
SUPPORTED_FLOWS = ["authorize", "create_client_authentication_token", "customer_create", "get", "proxy_authorize", "proxy_setup_recurring", "refund", "refund_get", "setup_recurring", "token_authorize", "void"]
