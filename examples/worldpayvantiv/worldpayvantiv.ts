...
function _buildReverseRequest(): PaymentServiceReverseRequest {
    return {
...
async function reverse(merchantTransactionId: string, config: ConnectorConfig = _defaultConfig): Promise<PaymentServiceReverseResponse> {
    const paymentClient = new PaymentClient(config);
