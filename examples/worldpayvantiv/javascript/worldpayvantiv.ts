...
// Run a scenario:  npx ts-node worldpayvantiv.ts checkout_card
...
async function reverse(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig): Promise<unknown> {
    // Step 1: reverse
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, capture, get, refund, reverse, voidPayment };
