// Auto-generated for worldpayvantiv
// Run: cargo run --example worldpayvantiv -- process_checkout_card
...
#[allow(dead_code)]
pub async fn reverse(client: &ConnectorClient, _merchant_id: &str) -> Result<String, Box<dyn std::error::Error>> {
    // Flow: PaymentService.reverse
    let response = client.reverse(
        serde_json::json!({
