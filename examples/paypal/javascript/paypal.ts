...
// Run a scenario:  npx ts-node paypal.ts checkout_card

import { PaymentClient, RecurringPaymentClient, MerchantAuthenticationClient } from 'hyperswitch-prism';
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processRecurring, processVoidPayment, processGetPayment, authorize, capture, createAccessToken, get, recurringCharge, refund, setupRecurring, voidPayment, _buildCreateAccessTokenRequest, _buildRecurringChargeRequest };
