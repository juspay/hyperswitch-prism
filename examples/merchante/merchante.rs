...
fn build_client() -> ConnectorClient {
    ...
    let config = ConnectorConfig {
        connector_config: Some(ConnectorSpecificConfig {
            config: Some(connector_specific_config::Config::Merchante(
                MerchanteConfig {
                    profile_id: Some(hyperswitch_masking::Secret::new(
                        "YOUR_PROFILE_ID".to_string(),
                    )), // Authentication credential
                    profile_key: Some(hyperswitch_masking::Secret::new(
                        "YOUR_PROFILE_KEY".to_string(),
                    )), // Authentication credential
