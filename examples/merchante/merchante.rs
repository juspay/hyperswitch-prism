...
// Regenerate: python3 scripts/generate-connector-docs.py merchante
//
// Merchante — all scenarios and flows in one file.
// Run a scenario:  cargo run --example merchante -- process_checkout_card
...
#[allow(dead_code)]
pub const SUPPORTED_FLOWS: &[&str] = &["authorize", "capture", "get", "proxy_authorize", "proxy_setup_recurring", "recurring_charge", "refund", "refund_get", "setup_recurring", "void"];
