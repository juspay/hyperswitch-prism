...
// Regenerate: python3 scripts/generate-connector-docs.py absa_sanlam
//
// Absa_Sanlam — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx absa_sanlam.ts checkout_autocapture
