...
SUPPORTED_FLOWS = ["capture", "create_client_authentication_token", "create_server_authentication_token", "get", "proxy_setup_recurring", "refund", "refund_get", "setup_recurring", "void"]
