...
# Run a scenario:  python3 flywire.py checkout_card
...
SUPPORTED_FLOWS = ["authenticate", "authorize", "get", "parse_event", "proxy_authorize", "refund", "refund_get", "token_authorize"]
...
def _build_parse_event_request():
    return payment_pb2.EventServiceParseRequest(
        request_details=payment_pb2.RequestDetails(
            ...
            body="{\"event_type\":\"guaranteed\",\"event_date\":\"2026-01-01T00:00:00Z\",\"event_resource\":\"payments\",\"data\":{\"payment_id\":\"PTU000000000\",\"status\":\"guaranteed\",\"external_reference\":\"sample\"}}",  # Body of the HTTP request.
        ),
    )
