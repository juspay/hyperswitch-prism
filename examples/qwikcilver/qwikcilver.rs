...
// Run a scenario:  cargo run --example qwikcilver -- process_checkout_card
...
fn build_client() -> ConnectorClient {
    ...
    let config = ConnectorConfig {
        connector_config: Some(ConnectorSpecificConfig {
            config: Some(connector_specific_config::Config::Qwikcilver(
                QwikcilverConfig {
                    bootstrap_bearer_token: Some(hyperswitch_masking::Secret::new(
                        "YOUR_BOOTSTRAP_BEARER_TOKEN".to_string(),
