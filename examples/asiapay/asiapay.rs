...
// Regenerate: python3 scripts/generate-connector-docs.py asiapay
//
// Asiapay — all scenarios and flows in one file.
// Run a scenario:  cargo run --example asiapay -- process_checkout_card
...
fn build_client() -> ConnectorClient {
    ...
    let config = ConnectorConfig {
        connector_config: Some(ConnectorSpecificConfig {
            config: Some(connector_specific_config::Config::Asiapay(AsiapayConfig {
                merchant_id: Some(hyperswitch_masking::Secret::new(
                    "YOUR_MERCHANT_ID".to_string(),
                )), // Authentication credential
                secure_hash_secret: Some(hyperswitch_masking::Secret::new(
                    "YOUR_SECURE_HASH_SECRET".to_string(),
                )), // Authentication credential
                login_id: Some(hyperswitch_masking::Secret::new(
                    "YOUR_LOGIN_ID".to_string(),
                )), // Authentication credential
