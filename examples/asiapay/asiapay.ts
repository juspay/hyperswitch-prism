...
// Run a scenario:  npx tsx asiapay.ts checkout_autocapture
...
export const SUPPORTED_FLOWS = ["authorize", "capture", "get", "parse_event", "proxy_authorize", "refund", "refund_get", "token_authorize", "void"];

const _defaultConfig: types.IConnectorConfig = {
    options: {
        environment: Environment.SANDBOX,
    },
    // connectorConfig: { asiapay: { apiKey: { value: 'YOUR_API_KEY' } } },
};
