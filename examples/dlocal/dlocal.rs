...
pub fn build_handle_event_request() -> EventServiceHandleRequest {
    EventServiceHandleRequest {
        ...
        request_details: Some(RequestDetails {
            ...
            body: "{\"id\":\"F-probe-001\",\"status\":\"PAID\",\"status_code\":\"200\",\"order_id\":\"probe_order_001\",\"payment_method_id\":\"RG\",\"payment_method_type\":\"WALLET\",\"payment_method_flow\":\"REDIRECT\"}".to_string(),  // Body of the HTTP request.
            ..Default::default()
        }),
        ..Default::default()
    }
