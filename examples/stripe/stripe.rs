...
pub async fn process_incremental_authorization(
    ...
    let response = client
        .incremental_authorization(
            TODO_FIX_MISSING_TYPE_incremental_authorization {
                merchant_authorization_id: "probe_auth_001".to_string(),
                connector_transaction_id: "probe_connector_txn_001".to_string(),
                // amount: {"minor_amount": 1100, "currency": "USD"}
                reason: "incremental_auth_probe".to_string(),
                ..Default::default()
            },
            &HashMap::new(),
            None,
