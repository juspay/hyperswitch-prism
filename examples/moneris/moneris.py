...
# Run a scenario:  python3 moneris.py checkout_card
...
SUPPORTED_FLOWS = ["authorize", "capture", "create_server_authentication_token", "get", "post_authenticate", "pre_authenticate", "proxy_authorize", "refund", "refund_get", "void"]
