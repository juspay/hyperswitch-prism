...
// Run a scenario:  npx ts-node finix.ts checkout_card

import { PaymentClient, CustomerClient, PaymentMethodClient } from 'hyperswitch-prism';
...
export { processCheckoutCard, processCheckoutAutocapture, processCheckoutWallet, processCheckoutBank, processRefund, processVoidPayment, processGetPayment, processCreateCustomer, processTokenize, authorize, capture, createCustomer, get, refund, tokenize, voidPayment, _buildCreateCustomerRequest, _buildTokenizeRequest };
