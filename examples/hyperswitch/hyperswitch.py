...
SUPPORTED_FLOWS = ["authorize", "capture", "create_server_authentication_token", "create_server_session_authentication_token", "get", "parse_event", "proxy_authorize", "proxy_setup_recurring", "refund", "refund_get", "setup_recurring", "tokenize", "void"]
