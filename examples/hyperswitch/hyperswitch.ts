...
//
// Hyperswitch — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx hyperswitch.ts checkout_autocapture

import { PaymentClient, MerchantAuthenticationClient, EventClient, RefundClient, PaymentMethodClient, types } from 'hyperswitch-prism';
const { Environment, AcceptanceType, AuthenticationType, CaptureMethod, CardNetwork, Currency, FutureUsage, HttpMethod } = types;
export const SUPPORTED_FLOWS = ["authorize", "capture", "create_server_authentication_token", "create_server_session_authentication_token", "get", "parse_event", "proxy_authorize", "proxy_setup_recurring", "refund", "refund_get", "setup_recurring", "tokenize", "void"];
...
function _buildHandleEventRequest(): types.IEventServiceHandleRequest {
    return {
        ...
        "requestDetails": {
            ...
            "body": new Uint8Array(Buffer.from("{\"merchant_id\":\"probe_merchant\",\"event_id\":\"evt_probe_001\",\"event_type\":\"payment_succeeded\",\"content\":{\"type\":\"payment_details\",\"object\":{\"payment_id\":\"pay_probe001\",\"status\":\"succeeded\",\"connector_transaction_id\":\"txn_probe001\"}}}", "utf-8"))  // Body of the HTTP request.
        }
    };
}
...
export {
    processCheckoutAutocapture, processCheckoutCard, processRefund, processVoidPayment, processGetPayment, authorize, capture, createServerAuthenticationToken, createServerSessionAuthenticationToken, get, handleEvent, parseEvent, proxyAuthorize, proxySetupRecurring, refund, refundGet, setupRecurring, tokenize, voidPayment, _buildAuthorizeRequest, _buildCaptureRequest, _buildCreateServerAuthenticationTokenRequest, _buildCreateServerSessionAuthenticationTokenRequest, _buildGetRequest, _buildHandleEventRequest, _buildParseEventRequest, _buildProxyAuthorizeRequest, _buildProxySetupRecurringRequest, _buildRefundRequest, _buildRefundGetRequest, _buildSetupRecurringRequest, _buildTokenizeRequest, _buildVoidRequest
};
