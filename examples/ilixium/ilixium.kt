...
// Regenerate: python3 scripts/generate-connector-docs.py ilixium
//
// Ilixium — all scenarios and flows in one file.
// Run a scenario:  ./gradlew run --args="ilixium processCheckoutCard"
...
import types.Payment.IlixiumConfig
