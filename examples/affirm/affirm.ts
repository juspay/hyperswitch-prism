...
// Regenerate: python3 scripts/generate-connector-docs.py affirm
//
// Affirm — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx affirm.ts checkout_autocapture
...
// Flow: PaymentService.Authorize (Affirm)
