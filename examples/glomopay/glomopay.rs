...
// Regenerate: python3 scripts/generate-connector-docs.py glomopay
//
// Glomopay — all scenarios and flows in one file.
// Run a scenario:  cargo run --example glomopay -- process_checkout_card
...
#[allow(dead_code)]
pub const SUPPORTED_FLOWS: &[&str] = &["authorize", "customer_get", "get", "parse_event", "proxy_authorize", "refund", "refund_get"];
...
pub fn build_handle_event_request() -> EventServiceHandleRequest {
    EventServiceHandleRequest {
        ...
        request_details: Some(RequestDetails {
            ...
            body: "{\"entity_type\":\"payment\",\"event_type\":\"in_progress\",\"data\":{\"id\":\"payt_686f7cc3pe69T\",\"payin_id\":\"order_686f7c8c7txqj\",\"status\":\"active\",\"payment_amount\":374580,\"payment_currency\":\"AED\",\"converted_amount\":102000,\"converted_currency\":\"USD\",\"requested_amount\":100000,\"requested_currency\":\"USD\",\"fees\":{\"txn_fee\":{\"currency\":\"USD\",\"amount\":1000},\"fx_fee\":{\"currency\":\"USD\",\"amount\":1000},\"referral_fee\":{\"currency\":\"USD\",\"amount\":0}},\"error_code\":null,\"error_description\":null,\"error_message\":null,\"funds_available\":false}}".as_bytes().to_vec(),  // Body of the HTTP request.
            ..Default::default()
        }),
        ..Default::default()
    }
...
#[allow(dead_code)]
pub async fn process_customer_get(client: &ConnectorClient, _merchant_transaction_id: &str) -> Result<String, Box<dyn std::error::Error>> {
    let response = client.customer_get(build_customer_get_request(), &HashMap::new(), None).await?;
...
async fn main() {
    ...
    let result: Result<String, Box<dyn std::error::Error>> = match flow.as_str() {
        ...
        _ => { eprintln!("Unknown flow: {}. Available: process_checkout_autocapture, process_refund, process_get_payment, process_authorize, process_customer_get, process_get, process_parse_event, process_proxy_authorize, process_refund_get", flow); return; }
    };
    match result {
        Ok(msg) => println!("✓ {msg}"),
        Err(e) => eprintln!("✗ {e}"),
