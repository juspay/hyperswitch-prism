    ...
    let authorize_response = client
        .authorize(
            TODO_FIX_MISSING_TYPE_authorize {
                ...
                // address: {"billing_address": {"line1": "123 Main St", "city": "Seattle", "state": "WA", "zip_code": "98101", "country_alpha2_code": "US"}}
    ...
    let response = client
        .parse_event(
            TODO_FIX_MISSING_TYPE_parse_event {
                // request_details: {"method": "HTTP_METHOD_POST", "uri": "https://example.com/webhook", "headers": {}, "body": "{\"object\":\"transaction\",\"trigger\":\"payment\",\"webhook_id\":\"probe_wh_001\",\"triggered_at\":\"2024-01-01T00:00:00Z\",\"triggered_on\":{\"id\":\"probe_txn_001\",\"object\":\"transaction\"},\"url\":\"https://example.com/webhook\"}"}
                ..Default::default()
            },
            &HashMap::new(),
            None,
