...
val SUPPORTED_FLOWS = listOf<String>("capture", "get", "proxy_authorize", "refund", "refund_get", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: capture, get, proxyAuthorize, refund, refundGet, void")
    }
}
