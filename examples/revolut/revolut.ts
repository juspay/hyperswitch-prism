...
const _defaultConfig: types.IConnectorConfig = {
    ...
    // connectorConfig: { revolut: { apiKey: { value: 'YOUR_API_KEY' } } },
};
...
async function verifyRedirect(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig) {
    ...
    const verifyResponse = await paymentClient.verifyRedirectResponse({
        // No required fields
    });
...
export {
    processCheckoutAutocapture, processCheckoutCard, processRefund, processGetPayment, authorize, capture, get, handleEvent, parseEvent, proxyAuthorize, refund, refundGet, tokenAuthorize, verifyRedirect
};
