...
//
// Robokassa — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx robokassa.ts checkout_autocapture

import { PaymentClient, types } from 'hyperswitch-prism';
const { Environment, AuthenticationType, CaptureMethod, CardNetwork, Currency } = types;
export const SUPPORTED_FLOWS = ["authorize", "proxy_authorize", "token_authorize"];
...
export {
    processCheckoutAutocapture, authorize, proxyAuthorize, tokenAuthorize, _buildAuthorizeRequest, _buildProxyAuthorizeRequest, _buildTokenAuthorizeRequest
};
