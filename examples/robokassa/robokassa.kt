...
// Regenerate: python3 scripts/generate-connector-docs.py robokassa
//
// Robokassa — all scenarios and flows in one file.
// Run a scenario:  ./gradlew run --args="robokassa processCheckoutCard"

package examples.robokassa
...
import types.Payment.RobokassaConfig
import payments.SecretString

val SUPPORTED_FLOWS = listOf<String>("authorize", "proxy_authorize", "token_authorize")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, authorize, proxyAuthorize, tokenAuthorize")
    }
}
