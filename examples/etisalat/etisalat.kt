...
// Run a scenario:  ./gradlew run --args="etisalat processCheckoutCard"

package examples.etisalat
...
import types.Payment.EtisalatConfig
import payments.SecretString

val SUPPORTED_FLOWS = listOf<String>("authorize", "capture", "proxy_authorize", "recurring_charge", "refund", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "refund" -> refund(txnId)
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processCheckoutCard, processRefund, processVoidPayment, authorize, capture, proxyAuthorize, recurringCharge, refund, void")
    }
}
