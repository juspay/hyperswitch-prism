...
//
// Etisalat — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx etisalat.ts checkout_autocapture
...
export const SUPPORTED_FLOWS = ["authorize", "capture", "proxy_authorize", "recurring_charge", "refund", "void"];
...
export {
    processCheckoutAutocapture, processCheckoutCard, processRefund, processVoidPayment, authorize, capture, proxyAuthorize, recurringCharge, refund, voidPayment, _buildAuthorizeRequest, _buildCaptureRequest, _buildProxyAuthorizeRequest, _buildRecurringChargeRequest, _buildRefundRequest, _buildVoidRequest
};
