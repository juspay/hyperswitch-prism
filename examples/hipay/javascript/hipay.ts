...
// Run a scenario:  npx ts-node hipay.ts checkout_card

import { PaymentClient, PaymentMethodClient, TokenizedPaymentClient } from 'hyperswitch-prism';
...
// Flow: tokenized_authorize → capture
...
async function processTokenizedCheckout(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig): Promise<unknown> {
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, processTokenize, processTokenizedCheckout, authorize, capture, get, refund, tokenize, tokenizedAuthorize, voidPayment, _buildTokenizeRequest, _buildTokenizedAuthorizeRequest };
