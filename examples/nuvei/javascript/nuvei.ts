...
// Run a scenario:  npx ts-node nuvei.ts checkout_card
...
async function createSessionToken(merchantTransactionId: string, config: types.IConnectorConfig = _defaultConfig): Promise<unknown> {
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, capture, createSessionToken, get, refund, voidPayment, _buildCreateSessionTokenRequest };
