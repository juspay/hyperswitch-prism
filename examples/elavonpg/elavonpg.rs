...
// Regenerate: python3 scripts/generate-connector-docs.py elavonpg
//
// Elavonpg — all scenarios and flows in one file.
// Run a scenario:  cargo run --example elavonpg -- process_checkout_card
