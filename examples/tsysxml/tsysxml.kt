...
// Regenerate: python3 scripts/generate-connector-docs.py tsysxml
//
// Tsysxml — all scenarios and flows in one file.
// Run a scenario:  ./gradlew run --args="tsysxml processCheckoutCard"

package examples.tsysxml
...
val _defaultConfig: ConnectorConfig = ConnectorConfig.newBuilder()
    ...
    // .setConnectorConfig(...) — set your Tsysxml credentials here
    .build()
