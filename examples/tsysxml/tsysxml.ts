...
//
// Tsysxml — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx tsysxml.ts checkout_autocapture
...
const _defaultConfig: types.IConnectorConfig = {
    ...
    // connectorConfig: { tsysxml: { apiKey: { value: 'YOUR_API_KEY' } } },
};
