...
// Regenerate: python3 scripts/generate-connector-docs.py pinelabs_online
//
// Pinelabs_Online — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx pinelabs_online.ts checkout_autocapture
