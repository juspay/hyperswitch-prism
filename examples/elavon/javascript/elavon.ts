...
// Run a scenario:  npx ts-node elavon.ts checkout_card
...
export { processCheckoutCard, processCheckoutAutocapture, processRefund, processGetPayment, authorize, capture, get, refund };
