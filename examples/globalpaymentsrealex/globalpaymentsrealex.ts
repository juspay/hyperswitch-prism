...
//
// Globalpaymentsrealex — all integration scenarios and flows in one file.
// Run a scenario:  npx tsx globalpaymentsrealex.ts checkout_autocapture
...
const _defaultConfig: types.IConnectorConfig = {
    ...
    // connectorConfig: { globalpaymentsrealex: { apiKey: { value: 'YOUR_API_KEY' } } },
};
