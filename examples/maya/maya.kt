...
val SUPPORTED_FLOWS = listOf<String>("get", "parse_event", "refund", "refund_get", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: get, handleEvent, parseEvent, refund, refundGet, verifyRedirect, void")
    }
}
