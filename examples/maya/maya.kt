...
// Regenerate: python3 scripts/generate-connector-docs.py maya
//
// Maya — all scenarios and flows in one file.
// Run a scenario:  ./gradlew run --args="maya processCheckoutCard"

package examples.maya
...
import types.Payment.MayaConfig
import payments.SecretString

val SUPPORTED_FLOWS = listOf<String>("authorize", "get", "parse_event", "proxy_authorize", "refund", "refund_get", "token_authorize", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, get, handleEvent, parseEvent, proxyAuthorize, refund, refundGet, tokenAuthorize, verifyRedirect, void")
    }
}
