...
val SUPPORTED_FLOWS = listOf<String>("capture", "customer_create", "get", "refund", "refund_get", "token_authorize", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: capture, customerCreate, get, refund, refundGet, tokenAuthorize, void")
    }
}
