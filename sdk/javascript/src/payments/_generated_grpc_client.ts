...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  PaymentServiceCreateOrderResponse: ["rawConnectorRequest", "rawConnectorResponse", "connectorFeatureData"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  PaymentServiceCreateOrderResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "sessionData": "ClientAuthenticationTokenData", "redirectionData": "RedirectForm", "connectorFeatureData": "SecretString", "rawConnectorStatus": "RawConnectorStatus" },
