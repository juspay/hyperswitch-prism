...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  AdditionalConnectorDetails: { "datatrans": "DatatransAdditionalInformation" },
  DatatransAdditionalInformation: { "amount": "Money" },
  ...
  PaymentServiceCaptureRequest: { "amountToCapture": "Money", "multipleCaptureData": "MultipleCaptureRequestData", "browserInfo": "BrowserInformation", "state": "ConnectorState", "orderTaxAmount": "Money", "splitPayments": "SplitPaymentsDetails", "additionalConnectorDetails": "AdditionalConnectorDetails" },
