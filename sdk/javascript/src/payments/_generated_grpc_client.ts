...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  PaymentServiceCreateOrderResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "sessionData": "ClientAuthenticationTokenData", "redirectionData": "RedirectForm", "rawConnectorStatus": "RawConnectorStatus" },
