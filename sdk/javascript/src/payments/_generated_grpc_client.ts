...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  AdditionalApplePayInfo: ["cardExpMonth", "cardExpYear"],
  AdditionalWalletCardInfo: ["cardExpMonth", "cardExpYear", "email"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  AdditionalWalletInfo: { "applePay": "AdditionalApplePayInfo", "googlePay": "AdditionalWalletCardInfo" },
  AdditionalPaymentData: { "card": "AdditionalCardInfo", "wallet": "AdditionalWalletInfo" },
