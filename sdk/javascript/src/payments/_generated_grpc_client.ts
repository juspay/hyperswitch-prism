...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  DccQuote: { "actualAmount": "Money", "markupAmount": "Money" },
  DynamicCurrencyConversionData: { "quote": "DccQuote" },
