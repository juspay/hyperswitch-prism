...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  PaymentMethodAuthenticationServiceAuthenticateRequest: { "amount": "Money", "paymentMethod": "PaymentMethod", "customer": "Customer", "address": "PaymentAddress", "authenticationData": "AuthenticationData", "browserInfo": "BrowserInformation", "state": "ConnectorState", "redirectionResponse": "RedirectionResponse", "domainData": "DomainData", "customerAcceptance": "CustomerAcceptance", "billingDescriptor": "BillingDescriptor", "l2L3Data": "L2L3Data" },
  PaymentMethodAuthenticationServiceAuthenticateResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "redirectionData": "RedirectForm", "authenticationData": "AuthenticationData", "state": "ConnectorState", "rawConnectorStatus": "RawConnectorStatus", "mandateReferenceDetails": "MandateReferenceDetails" },
