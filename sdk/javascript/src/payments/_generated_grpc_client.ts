...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  PlaidClientAuthenticationResponse: ["linkToken"],
  StripeClientAuthenticationResponse: ["clientSecret"],
  GpayTokenParameters: ["publicKey"],
  SecretInfoToInitiateSdk: ["display", "payment"],
  RecipientBankAccountIban: ["iban"],
  RecipientBankAccountRoutingNumber: ["accountNumber", "routingNumber"],
  RecipientBankAccountBic: ["accountNumber", "bic"],
  RecipientBareAccountNumber: ["accountNumber"],
  RecipientBankAccountTruncatedPan: ["cardIsin", "last4"],
  RecipientAccount: ["cardNumber", "walletId", "email", "phoneNumber", "socialNetworkId"],
  RecipientDetails: ["phoneNumber", "taxId"],
  ...
  PaymentServiceVoidResponse: ["rawConnectorRequest", "typedConnectorRequest", "connectorFeatureData", "rawConnectorResponse", "typedConnectorResponse"],
  PaymentServiceReverseRequest: ["metadata", "connectorFeatureData"],
  PaymentServiceReverseResponse: ["rawConnectorRequest", "typedConnectorRequest", "rawConnectorResponse", "typedConnectorResponse"],
  ...
  MerchantAuthenticationServiceCreateClientAuthenticationTokenResponse: ["rawConnectorResponse", "typedConnectorResponse", "rawConnectorRequest", "typedConnectorRequest"],
  PaymentServiceCaptureRequest: ["metadata", "connectorFeatureData"],
  PaymentServiceCaptureResponse: ["rawConnectorRequest", "typedConnectorRequest", "connectorFeatureData", "rawConnectorResponse", "typedConnectorResponse"],
  PaymentServiceCreateOrderRequest: ["metadata", "connectorFeatureData"],
  PaymentServiceCreateOrderResponse: ["rawConnectorRequest", "typedConnectorRequest", "rawConnectorResponse", "typedConnectorResponse"],
  PaymentServiceRefundRequest: ["metadata", "refundMetadata", "connectorFeatureData"],
  RefundResponse: ["email", "metadata", "refundMetadata", "acquirerReferenceNumber", "rawConnectorResponse", "typedConnectorResponse", "rawConnectorRequest", "typedConnectorRequest", "stateMetadata"],
  ...
  PaymentMethodAuthenticationServicePreAuthenticateResponse: ["connectorFeatureData", "rawConnectorResponse", "typedConnectorResponse"],
  PaymentMethodAuthenticationServiceAuthenticateRequest: ["metadata", "connectorFeatureData"],
  PaymentMethodAuthenticationServiceAuthenticateResponse: ["connectorFeatureData", "rawConnectorResponse", "typedConnectorResponse"],
  PaymentMethodAuthenticationServicePostAuthenticateRequest: ["metadata", "connectorFeatureData"],
  PaymentMethodAuthenticationServicePostAuthenticateResponse: ["connectorFeatureData", "rawConnectorResponse", "typedConnectorResponse"],
  PaymentServiceIncrementalAuthorizationRequest: ["connectorFeatureData"],
  PaymentServiceIncrementalAuthorizationResponse: ["rawConnectorRequest", "typedConnectorRequest", "rawConnectorResponse", "typedConnectorResponse"],
  PaymentServiceVerifyRedirectResponseRequest: ["connectorFeatureData"],
  PaymentServiceVerifyRedirectResponseResponse: ["rawConnectorResponse", "typedConnectorResponse", "connectorFeatureData"],
  RefundServiceGetRequest: ["refundMetadata", "connectorFeatureData"],
  DisputeServiceSubmitEvidenceResponse: ["rawConnectorRequest", "typedConnectorRequest"],
  DisputeServiceDefendResponse: ["rawConnectorRequest", "typedConnectorRequest"],
  DisputeServiceAcceptResponse: ["rawConnectorRequest", "typedConnectorRequest"],
  ...
  PaymentMethodServiceCreateResponse: ["rawConnectorResponse", "typedConnectorResponse", "rawConnectorRequest", "typedConnectorRequest"],
  PaymentMethodServiceGetRequest: ["connectorFeatureData", "metadata"],
  PaymentMethodServiceGetResponse: ["rawConnectorResponse", "typedConnectorResponse", "rawConnectorRequest", "typedConnectorRequest"],
  PaymentMethodServiceRefreshResponse: ["rawConnectorResponse", "typedConnectorResponse", "rawConnectorRequest", "typedConnectorRequest"],
  ...
  PaymentMethodServiceRechargeResponse: ["rawConnectorResponse", "typedConnectorResponse", "rawConnectorRequest", "typedConnectorRequest"],
  ...
  GotymeSanlamConfig: ["apiKey", "profileId"],
  ...
  MayaConfig: ["publicKey", "secretKey"],
  GlobalpaymentsRealexConfig: ["sharedSecret", "merchantId", "account", "refundPassword"],
  ...
  SepaBankTransferPayout: ["iban", "bic", "accountHolderName"],
  ...
  PayshapBankTransferPayout: ["bankAccountNumber", "accountHolderName"],
  PayshapProxyBankTransferPayout: ["cellphone", "shapId"],
  ...
  FrmServicePreRiskCheckRequest: ["metadata", "connectorFeatureData", "gatewayMetadata"],
  FrmServicePreRiskCheckResponse: ["rawConnectorRequest", "typedConnectorRequest", "rawConnectorResponse", "typedConnectorResponse"],
  FrmServicePrePayoutRiskCheckRequest: ["gatewayMetadata"],
  ...
  CompositeFrmPreRiskCheckRequest: ["metadata", "connectorFeatureData", "gatewayMetadata"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  RedirectForm: { "form": "FormData", "html": "HtmlData", "uri": "UriData", "braintree": "BraintreeData", "mifinity": "MifinityData", "nmi": "NmiData", "hostedIframe": "HostedIframeData", "script": "ScriptData", "worldpayxmlDdc": "WorldpayxmlDdcData", "worldpayxmlChallenge": "WorldpayxmlChallengeData" },
  ...
  ClientAuthenticationTokenData: { "googlePay": "GpayClientAuthenticationResponse", "paypal": "PaypalClientAuthenticationResponse", "applePay": "ApplepayClientAuthenticationResponse", "connectorSpecific": "ConnectorSpecificClientAuthenticationResponse", "authenticatorConnectorSpecific": "AuthenticatorConnectorSpecificClientAuthenticationResponse" },
  AuthenticatorConnectorSpecificClientAuthenticationResponse: { "plaid": "PlaidClientAuthenticationResponse" },
  ...
  RecipientBankAccount: { "iban": "RecipientBankAccountIban", "routingNumber": "RecipientBankAccountRoutingNumber", "bic": "RecipientBankAccountBic", "accountNumber": "RecipientBareAccountNumber", "truncatedPan": "RecipientBankAccountTruncatedPan" },
  RecipientAccount: { "bankAccount": "RecipientBankAccount" },
  RecipientDetails: { "account": "RecipientAccount", "address": "Address" },
  PaymentServiceAuthorizeRequest: { "amount": "Money", "paymentMethod": "PaymentMethod", "customer": "Customer", "address": "PaymentAddress", "authenticationData": "AuthenticationData", "customerAcceptance": "CustomerAcceptance", "browserInfo": "BrowserInformation", "setupMandateDetails": "SetupMandateDetails", "billingDescriptor": "BillingDescriptor", "state": "ConnectorState", "orderDetails": "OrderDetailsWithAmount", "redirectionResponse": "RedirectionResponse", "l2L3Data": "L2L3Data", "domainData": "DomainData", "splitPayments": "SplitPaymentsDetails", "splitSettlement": "SplitSettlement", "surchargeAmount": "Money", "partnerMerchantIdentifierDetails": "PartnerMerchantIdentifierDetails", "currencyConversionData": "CurrencyConversionData", "recipientDetails": "RecipientDetails", "additionalConnectorDetails": "AdditionalConnectorDetails" },
  ...
  PaymentServiceReverseResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "rawConnectorStatus": "RawConnectorStatus" },
  ...
  OsBasedReturnUrl: { "returnUrlMap": "ReturnUrlMapEntry" },
  AuthenticatorClientAuthenticationContext: { "customer": "Customer", "osBasedReturnUrl": "OsBasedReturnUrl" },
  ...
  PaymentServiceCreateOrderRequest: { "amount": "Money", "state": "ConnectorState", "orderDetails": "OrderDetailsWithAmount", "customer": "Customer" },
  ...
  PaymentServiceRefundRequest: { "refundAmount": "Money", "browserInfo": "BrowserInformation", "state": "ConnectorState", "paymentMethod": "PaymentMethod", "splitRefunds": "SplitRefundsDetails", "splitSettlementRefund": "SplitSettlementRefund" },
  RefundResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "refundAmount": "Money", "state": "ConnectorState", "rawConnectorStatus": "RawConnectorStatus", "splitSettlement": "SplitSettlementResponse" },
  ...
  PaymentMethodAuthenticationServiceAuthenticateResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "redirectionData": "RedirectForm", "authenticationData": "AuthenticationData", "state": "ConnectorState", "rawConnectorStatus": "RawConnectorStatus" },
  ...
  PaymentMethodAuthenticationServicePostAuthenticateResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "redirectionData": "RedirectForm", "authenticationData": "AuthenticationData", "state": "ConnectorState", "rawConnectorStatus": "RawConnectorStatus" },
  ...
  PaymentMethodServiceTokenizeRequest: { "amount": "Money", "paymentMethod": "PaymentMethod", "customer": "Customer", "address": "PaymentAddress", "state": "ConnectorState", "splitPayments": "SplitPaymentsDetails", "customerAcceptance": "CustomerAcceptance", "setupMandateDetails": "SetupMandateDetails" },
  ...
  BankAccountDetails: { "accounts": "BankAccount" },
  ...
  PaysafePaymentMethodDetails: { "card": "CardEntry", "ach": "AchEntry", "applePay": "ApplePayEntry", "interac": "InteracEntry", "skrill": "SkrillEntry", "paySafeCard": "PaySafeCardEntry", "neteller": "NetellerEntry" },
  ...
  NetellerEntry: { "value": "PaysafeRedirectAccountId" },
  ...
  PaymentMethodServiceEligibilityRequest: { "amount": "Money", "customer": "Customer", "address": "PaymentAddress", "orderDetails": "OrderDetailsWithAmount", "state": "ConnectorState" },
  PaymentMethodEligibilityResult: { "errorInfo": "ErrorInfo", "paymentMethodDetails": "PaymentMethodDetails" },
  PaymentMethodServiceEligibilityResponse: { "errorInfo": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "paymentMethodDetails": "PaymentMethodDetails", "results": "PaymentMethodEligibilityResult" },
  ConnectorSplitResponseData: { "stripeSplitResponse": "StripeSplitResponseData", "adyenSplitResponse": "AdyenSplitData" },
  SplitSettlement: { "marketplaceSplitDetails": "SplitSettlementMarketplace", "vendorSplitDetails": "SplitSettlementVendor" },
  SplitSettlementMarketplace: { "amount": "Money" },
  SplitSettlementVendor: { "amount": "Money", "merchantCommission": "Money" },
  SplitSettlementRefund: { "marketplaceSplitDetails": "SplitSettlementRefundMarketplace", "vendorSplitDetails": "SplitSettlementRefundVendor" },
  SplitSettlementRefundMarketplace: { "refundAmount": "Money" },
  SplitSettlementRefundVendor: { "refundAmount": "Money", "merchantCommission": "Money" },
  ...
  PayoutMethod: { "card": "CardPayout", "ach": "AchBankTransferPayout", "bacs": "BacsBankTransferPayout", "sepa": "SepaBankTransferPayout", "pix": "PixBankTransferPayout", "applePayDecrypt": "ApplePayDecrypt", "paypal": "Paypal", "venmo": "Venmo", "interac": "InteracPayout", "openBankingUk": "OpenBankingUkPayout", "passthrough": "Passthrough", "pixKey": "PixKeyBankTransferPayout", "pixEmv": "PixEmvBankTransferPayout", "openBanking": "OpenBankingPayout", "trustly": "TrustlyBankTransferPayout", "payshap": "PayshapBankTransferPayout", "payshapProxy": "PayshapProxyBankTransferPayout" },
  SourceBankData: { "ach": "AchBankTransferPayout", "bacs": "BacsBankTransferPayout", "sepa": "SepaBankTransferPayout", "pix": "PixBankTransferPayout", "pixKey": "PixKeyBankTransferPayout", "pixEmv": "PixEmvBankTransferPayout", "payshap": "PayshapBankTransferPayout", "payshapProxy": "PayshapProxyBankTransferPayout", "trustly": "TrustlyBankTransferPayout" },
  ...
  FrmServicePrePayoutRiskCheckRequest: { "amount": "Money", "payoutMethod": "PayoutMethod", "state": "ConnectorState" },
  FrmServicePrePayoutRiskCheckResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry" },
  ...
  CompositeFrmPreRiskCheckRequest: { "amount": "Money", "customerInfo": "Customer", "paymentMethod": "PaymentMethod", "browserInfo": "BrowserInformation", "orderDetails": "OrderDetailsWithAmount", "address": "PaymentAddress", "state": "ConnectorState", "mandateDetails": "MandateAmountData", "merchantDetails": "MerchantDetails" },
  CompositeFrmPostRiskCheckRequest: { "amount": "Money", "customerInfo": "Customer", "paymentMethod": "PaymentMethod", "orderDetails": "OrderDetailsWithAmount", "state": "ConnectorState", "address": "PaymentAddress" },
  ...
  EventContent: { "paymentsResponse": "PaymentServiceGetResponse", "refundsResponse": "RefundResponse", "disputesResponse": "DisputeResponse", "payoutsResponse": "PayoutServiceGetResponse" },
...
export class GrpcFraudAndRiskManagementClient {
  ...
  async prePayoutRiskCheck(req: unknown): Promise<unknown> {
    return callGrpc(this.ffi, this.config, "fraud_and_risk_management/pre_payout_risk_check",
      req, types.FrmServicePrePayoutRiskCheckRequest, types.FrmServicePrePayoutRiskCheckResponse);
  }
}
...
export class GrpcPaymentMethodClient {
  ...
  async create(req: unknown): Promise<unknown> {
    return callGrpc(this.ffi, this.config, "payment_method/create",
      req, types.PaymentMethodServiceCreateRequest, types.PaymentMethodServiceCreateResponse);
  }
...
export class GrpcRefundClient {
  ...
  async voidPostRefund(req: unknown): Promise<unknown> {
    return callGrpc(this.ffi, this.config, "refund/void_post_refund",
      req, types.RefundServiceVoidPostRefundRequest, types.RefundResponse);
  }
}
