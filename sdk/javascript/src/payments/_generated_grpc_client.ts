...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  ThreeDsSdkInformation: ["sdkEncData", "sdkServerSignedContent"],
  ...
  NetceteraConfig: ["certificate", "privateKey"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  ThreeDsSdkInformation: { "sdkEphemPubKey": "ThreeDsSdkEphemeralPublicKey", "deviceDetails": "ThreeDsSdkDeviceDetails" },
  ...
  PaymentMethodAuthenticationServiceAuthenticateRequest: { "amount": "Money", "paymentMethod": "PaymentMethod", "customer": "Customer", "address": "PaymentAddress", "authenticationData": "AuthenticationData", "browserInfo": "BrowserInformation", "state": "ConnectorState", "redirectionResponse": "RedirectionResponse", "domainData": "DomainData", "merchantDetails": "MerchantDetails", "acquirerDetails": "AcquirerDetails", "sdkInformation": "ThreeDsSdkInformation" },
