...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  ConnectorMandateReferenceId: ["connectorMandateId", "paymentMethodId", "connectorMandateRequestReferenceId", "mandateMetadata", "updatedMandateDetails"],
  MandateUpdateHistory: ["connectorMandateId", "originalPaymentId"],
  UpdatedMandateDetails: ["cardNetwork", "cardExpMonth", "cardExpYear", "cardIsin"],
  NetworkMandateId: ["transactionLinkId"],
  NetworkTokenWithNTI: ["tokenExpMonth", "tokenExpYear", "transactionLinkId"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  MandateReference: { "connectorMandateId": "ConnectorMandateReferenceId", "networkMandateId": "NetworkMandateId", "networkTokenWithNti": "NetworkTokenWithNTI", "cardWithLimitedData": "Empty" },
  ...
  PaymentServiceAuthorizeResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "redirectionData": "RedirectForm", "state": "ConnectorState", "authorizedMoney": "Money", "mandateReference": "MandateReference", "connectorResponse": "ConnectorResponseData", "splits": "ConnectorSplitResponseData" },
  ...
  PaymentServiceSetupRecurringResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "mandateReference": "MandateReference", "redirectionData": "RedirectForm", "connectorResponse": "ConnectorResponseData", "state": "ConnectorState", "splits": "ConnectorSplitResponseData" },
