...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  PaymentServiceVoidRequest: { "browserInfo": "BrowserInformation", "amount": "Money", "state": "ConnectorState", "stripeSplitPayment": "StripeSplitPaymentRequest" },
  ...
  PaymentMethodServiceTokenizeRequest: { "amount": "Money", "paymentMethod": "PaymentMethod", "customer": "Customer", "address": "PaymentAddress", "state": "ConnectorState", "stripeSplitPayment": "StripeSplitPaymentRequest" },
  ...
  CustomerServiceCreateRequest: { "address": "PaymentAddress", "stripeSplitPayment": "StripeSplitPaymentRequest" },
