...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  RawStoredCardForPMID: ["cardNumber", "cardExpMonth", "cardExpYear", "nickName", "cardHolderName", "networkTransactionId"],
