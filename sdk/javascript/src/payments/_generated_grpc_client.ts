...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  NotifyConnectorsRequest: { "content": "NotifyConnectorContent" },
  NotifyConnectorContent: { "surchargeDetails": "SurchargeDetails" },
  NotifyConnectorsResponse: { "error": "ErrorInfo" },
...
export class GrpcEventClient {
  ...
  async notifyConnectors(req: unknown): Promise<unknown> {
    return callGrpc(this.ffi, this.config, "event/notify_connectors",
      req, types.NotifyConnectorsRequest, types.NotifyConnectorsResponse);
  }
}
