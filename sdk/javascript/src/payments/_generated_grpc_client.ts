...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  PaymentServiceAuthorizeRequest: ["metadata", "connectorFeatureData", "connectorIntentMetadata"],
  ...
  PaymentServiceCaptureRequest: ["metadata", "connectorFeatureData", "connectorIntentMetadata"],
  ...
  RecurringPaymentServiceChargeRequest: ["metadata", "connectorFeatureData", "email", "merchantAccountId", "connectorTestingData", "connectorIntentMetadata"],
