...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  MandateReferenceResponse: ["mandateMetadata"],
  ConnectorMandateReferenceId: ["mandateMetadata"],
  UpdatedMandateDetails: ["cardExpMonth", "cardExpYear"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  ConnectorMandateReferenceId: { "updateHistory": "MandateUpdateHistory", "updatedMandateDetails": "UpdatedMandateDetails" },
  ...
  DomainData: { "airlineData": "AirlineData" },
  ...
  PaymentServiceVoidResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "state": "ConnectorState", "mandateReference": "MandateReference", "splits": "ConnectorSplitResponseData", "mandateReferenceResponse": "MandateReferenceResponse" },
  ...
  PaymentServiceCaptureResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "state": "ConnectorState", "mandateReference": "MandateReference", "connectorResponse": "ConnectorResponseData", "splits": "ConnectorSplitResponseData", "mandateReferenceResponse": "MandateReferenceResponse" },
  ...
  PaymentServiceSetupRecurringResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "mandateReference": "MandateReference", "redirectionData": "RedirectForm", "connectorResponse": "ConnectorResponseData", "state": "ConnectorState", "splits": "ConnectorSplitResponseData", "mandateReferenceResponse": "MandateReferenceResponse" },
  ...
  RecurringPaymentServiceChargeResponse: { "error": "ErrorInfo", "responseHeaders": "ResponseHeadersEntry", "mandateReference": "MandateReference", "state": "ConnectorState", "connectorResponse": "ConnectorResponseData", "splits": "ConnectorSplitResponseData", "mandateReferenceResponse": "MandateReferenceResponse" },
  ...
  FrmServicePreRiskCheckRequest: { "amount": "Money", "customerInfo": "Customer", "paymentMethod": "PaymentMethod", "browserInfo": "BrowserInformation", "orderDetails": "OrderDetailsWithAmount", "address": "Address", "state": "ConnectorState", "mandateInfo": "MandateAmountData", "merchantDetails": "MerchantDetails", "mandateDetails": "MandateAmountData" },
  ...
  CompositeFrmPreRiskCheckRequest: { "amount": "Money", "customerInfo": "Customer", "paymentMethod": "PaymentMethod", "browserInfo": "BrowserInformation", "orderDetails": "OrderDetailsWithAmount", "address": "Address", "state": "ConnectorState", "mandateInfo": "MandateAmountData", "merchantDetails": "MerchantDetails", "mandateDetails": "MandateAmountData" },
