...
function loadGrpcFfi(libPath?: string): GrpcFfi {
  if (!libPath) {
    ...
    libPath = path.join(
      _dirname,
      "generated",
      `libhyperswitch_grpc_ffi.${ext}`,
    );
  }

  const lib = koffi.load(libPath);

  const call = lib.func("hyperswitch_grpc_call", koffi.pointer("uint8"), [
    "str",
    koffi.pointer("uint8"),
    "uint32",
    koffi.pointer("uint8"),
...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  ApplePayDecryptedData: [
    ...
    "applicationExpirationMonth",
    "applicationExpirationYear",
  ],
  ...
  CheckoutClientAuthenticationResponse: [
    "paymentSessionToken",
  ...
  PeachpaymentsConfig: [
    "apiKey",
    "tenantId",
    "clientMerchantReferenceId",
    "merchantPaymentMethodRouteId",
  ],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  PaymentMethod: {
    ...
    cardProxy: "ProxyCardDetails",
    token: "TokenPaymentMethodType",
    applePaySdk: "AppleWallet",
    googlePaySdk: "GoogleWallet",
    paypalSdk: "PaypalSdkWallet",
    pazeSdk: "PazeWallet",
    samsungPaySdk: "SamsungWallet",
    applePayThirdPartySdk: "ApplePayThirdPartySdkWallet",
    googlePayThirdPartySdk: "GooglePayThirdPartySdkWallet",
    amazonPayRedirect: "AmazonPayRedirectWallet",
    paypalRedirect: "PaypalRedirectWallet",
    aliPayRedirect: "AliPayRedirectWallet",
    revolutPayRedirect: "RevolutPayRedirectWallet",
    mifinityRedirect: "MifinityRedirectWallet",
    bluecodeRedirect: "BluecodeRedirectWallet",
    satispayRedirect: "SatispayRedirectWallet",
    weroRedirect: "WeroRedirectWallet",
    lazypayRedirect: "LazyPayRedirectWallet",
    phonepeRedirect: "PhonePeRedirectWallet",
    billdeskRedirect: "BillDeskRedirectWallet",
    cashfreeRedirect: "CashfreeRedirectWallet",
    payuRedirect: "PayURedirectWallet",
    easebuzzRedirect: "EaseBuzzRedirectWallet",
    kakaoPayRedirect: "KakaoPayRedirectWallet",
    mbWayRedirect: "MbWayRedirectWallet",
    momoRedirect: "MomoRedirectWallet",
    touchNGoRedirect: "TouchNGoRedirectWallet",
    twintRedirect: "TwintRedirectWallet",
    vippsRedirect: "VippsRedirectWallet",
    weChatPayRedirect: "WeChatPayRedirectWallet",
    aliPayHkRedirect: "AliPayHKRedirectWallet",
    danaRedirect: "DanaRedirectWallet",
    gcashRedirect: "GcashRedirectWallet",
    goPayRedirect: "GoPayRedirectWallet",
    mobilePayRedirect: "MobilePayRedirectWallet",
    venmoRedirect: "VenmoRedirectWallet",
    skrillRedirect: "SkrillRedirectWallet",
    payseraRedirect: "PayseraRedirectWallet",
    revolutPay: "RevolutPayWallet",
    mbWay: "MBWay",
    satispay: "Satispay",
    wero: "Wero",
    cashappQr: "CashappQrWallet",
    weChatPayQr: "WeChatPayQrWallet",
    swishQr: "SwishQrWallet",
    upiCollect: "UpiCollect",
    upiIntent: "UpiIntent",
    upiQr: "UpiQr",
    onlineBankingThailand: "OnlineBankingThailand",
    ...
    localBankRedirect: "LocalBankRedirect",
    ideal: "Ideal",
    sofort: "Sofort",
    trustly: "Trustly",
    giropay: "Giropay",
    ...
    pse: "Pse",
    bancontactCard: "BancontactCard",
    blik: "Blik",
    openBanking: "OpenBanking",
    interac: "Interac",
    bizum: "Bizum",
    eftBankRedirect: "EftBankRedirect",
    duitNow: "DuitNow",
    crypto: "CryptoCurrency",
    classicReward: "ClassicReward",
    eVoucher: "EVoucher",
    ...
    multibancoBankTransfer: "MultibancoBankTransfer",
    instantBankTransferFinland: "InstantBankTransferFinland",
    instantBankTransferPoland: "InstantBankTransferPoland",
    pix: "PixPayment",
    permataBankTransfer: "PermataBankTransfer",
    bcaBankTransfer: "BCABankTransfer",
    bniVaBankTransfer: "BNIVaBankTransfer",
    briVaBankTransfer: "BRIVaBankTransfer",
    cimbVaBankTransfer: "CIMBVaBankTransfer",
    danamonVaBankTransfer: "DanamonVaBankTransfer",
    mandiriVaBankTransfer: "MandiriVaBankTransfer",
    localBankTransfer: "LocalBankTransfer",
    indonesianBankTransfer: "IndonesianBankTransfer",
    ach: "Ach",
    sepa: "Sepa",
    bacs: "Bacs",
    becs: "Becs",
    sepaGuaranteedDebit: "SepaGuaranteedDebit",
    eft: "Eft",
    affirm: "Affirm",
  ...
  TokenizationData: {
    ...
    encryptedData: "GooglePayEncryptedTokenizationData",
  },
  ...
  PazeDecryptedData: {
    token: "PazeToken",
    dynamicData: "PazeDynamicData",
    billingAddress: "PazeAddress",
    consumer: "PazeConsumer",
  },
  ErrorInfo: {
    unifiedDetails: "UnifiedErrorDetails",
    issuerDetails: "IssuerErrorDetails",
    connectorDetails: "ConnectorErrorDetails",
  },
  ...
  EventContent: {
    paymentsResponse: "PaymentServiceGetResponse",
    refundsResponse: "RefundResponse",
    disputesResponse: "DisputeResponse",
  },
  ...
  AdditionalPaymentMethodConnectorResponse: {
    card: "CardConnectorResponse",
    upi: "UpiConnectorResponse",
    googlePay: "GooglePayConnectorResponse",
    applePay: "ApplePayConnectorResponse",
    bankRedirect: "BankRedirectConnectorResponse",
  },
  ConnectorResponseData: {
    additionalPaymentMethodData: "AdditionalPaymentMethodConnectorResponse",
    extendedAuthorizationResponseData: "ExtendedAuthorizationResponseData",
  },
  PaymentMethodUpdate: { card: "CardDetailUpdate" },
  ClientAuthenticationTokenData: {
    googlePay: "GpayClientAuthenticationResponse",
    paypal: "PaypalClientAuthenticationResponse",
    applePay: "ApplepayClientAuthenticationResponse",
    connectorSpecific: "ConnectorSpecificClientAuthenticationResponse",
  },
  ...
  GpayClientAuthenticationResponse: {
  ...
  GooglePaySessionResponse: {
    ...
    allowedPaymentMethods: "GpayAllowedPaymentMethods",
  ...
  GpayAllowedMethodsParameters: {
    billingAddressParameters: "GpayBillingAddressParameters",
  },
  GpayTokenizationSpecification: { parameters: "GpayTokenParameters" },
  ApplepayClientAuthenticationResponse: {
    sessionResponse: "ApplePaySessionResponse",
    paymentRequestData: "ApplePayPaymentRequest",
  },
  ...
  PaymentServiceAuthorizeRequest: {
    ...
    orderDetails: "OrderDetailsWithAmount",
  ...
  PaymentServiceAuthorizeResponse: {
    ...
    redirectionData: "RedirectForm",
    state: "ConnectorState",
    mandateReference: "MandateReference",
    connectorResponse: "ConnectorResponseData",
  },
  ...
  MerchantAuthenticationServiceCreateClientAuthenticationTokenRequest: {
    payment: "PaymentClientAuthenticationContext",
    permissions: "Permissions",
  },
  PaymentClientAuthenticationContext: { amount: "Money", customer: "Customer" },
  MerchantAuthenticationServiceCreateClientAuthenticationTokenResponse: {
    sessionData: "ClientAuthenticationTokenData",
    error: "ErrorInfo",
  },
  PaymentServiceCaptureRequest: {
    amountToCapture: "Money",
    multipleCaptureData: "MultipleCaptureRequestData",
    browserInfo: "BrowserInformation",
    state: "ConnectorState",
  },
  PaymentServiceCaptureResponse: {
  ...
  RecurringPaymentServiceChargeRequest: {
    connectorRecurringPaymentId: "MandateReference",
    amount: "Money",
    paymentMethod: "PaymentMethod",
    address: "PaymentAddress",
    browserInfo: "BrowserInformation",
    state: "ConnectorState",
    originalPaymentAuthorizedAmount: "Money",
    billingDescriptor: "BillingDescriptor",
    authenticationData: "AuthenticationData",
    customer: "Customer",
    l2L3Data: "L2L3Data",
  ...
  EventReference: {
    payment: "PaymentEventReference",
    refund: "RefundEventReference",
    dispute: "DisputeEventReference",
    mandate: "MandateEventReference",
    payout: "PayoutEventReference",
  },
  EventServiceParseRequest: { requestDetails: "RequestDetails" },
  EventServiceParseResponse: { reference: "EventReference" },
  EventContext: {
    payment: "PaymentEventContext",
    refund: "RefundEventContext",
    dispute: "DisputeEventContext",
    mandate: "MandateEventContext",
    payout: "PayoutEventContext",
  },
  ...
  PaymentServiceVerifyRedirectResponseRequest: {
    requestDetails: "RequestDetails",
    redirectResponseSecrets: "RedirectResponseSecrets",
  },
  PaymentServiceVerifyRedirectResponseResponse: {
    responseAmount: "Money",
    error: "ErrorInfo",
  },
  ...
  CustomerServiceUpdateResponse: {
    customer: "Customer",
    error: "ErrorInfo",
    responseHeaders: "ResponseHeadersEntry",
  },
  CustomerServiceDeleteResponse: {
    error: "ErrorInfo",
    responseHeaders: "ResponseHeadersEntry",
  },
  ...
  ConnectorSpecificConfig: {
    ...
    bambora: "BamboraConfig",
    bankofamerica: "BankOfAmericaConfig",
    billwerk: "BillwerkConfig",
    bluesnap: "BluesnapConfig",
    braintree: "BraintreeConfig",
    cashtocode: "CashtocodeConfig",
    ...
    elavon: "ElavonConfig",
    fiserv: "FiservConfig",
    fiservemea: "FiservemeaConfig",
    forte: "ForteConfig",
    getnet: "GetnetConfig",
    globalpay: "GlobalpayConfig",
    hipay: "HipayConfig",
    helcim: "HelcimConfig",
    iatapay: "IatapayConfig",
    jpmorgan: "JpmorganConfig",
    mifinity: "MifinityConfig",
    mollie: "MollieConfig",
    multisafepay: "MultisafepayConfig",
    nexinets: "NexinetsConfig",
    nexixpay: "NexixpayConfig",
    nmi: "NmiConfig",
    noon: "NoonConfig",
    novalnet: "NovalnetConfig",
    nuvei: "NuveiConfig",
    paybox: "PayboxConfig",
    payme: "PaymeConfig",
    payu: "PayuConfig",
    ...
    stax: "StaxConfig",
    stripe: "StripeConfig",
    trustpay: "TrustpayConfig",
    tsys: "TsysConfig",
    volt: "VoltConfig",
    wellsfargo: "WellsfargoConfig",
    worldpay: "WorldpayConfig",
    worldpayvantiv: "WorldpayvantivConfig",
    xendit: "XenditConfig",
    ...
    authipay: "AuthipayConfig",
    silverflow: "SilverflowConfig",
    celero: "CeleroConfig",
    trustpayments: "TrustpaymentsConfig",
    paysafe: "PaysafeConfig",
    barclaycard: "BarclaycardConfig",
    worldpayxml: "WorldpayxmlConfig",
    revolut: "RevolutConfig",
    loonio: "LoonioConfig",
    gigadat: "GigadatConfig",
    hyperpg: "HyperpgConfig",
    zift: "ZiftConfig",
    screenstream: "ScreenstreamConfig",
    ebanx: "EbanxConfig",
    fiuu: "FiuuConfig",
    globepay: "GlobepayConfig",
    coinbase: "CoinbaseConfig",
    coingate: "CoingateConfig",
    revolv3: "Revolv3Config",
    authorizedotnet: "AuthorizedotnetConfig",
    peachpayments: "PeachpaymentsConfig",
    paypal: "PaypalConfig",
    truelayer: "TruelayerConfig",
    fiservcommercehub: "FiservcommercehubConfig",
    itaubank: "ItaubankConfig",
    ppro: "PproConfig",
    trustly: "TrustlyConfig",
    sanlam: "SanlamConfig",
    pinelabsOnline: "PinelabsOnlineConfig",
    imerchantsolutions: "ImerchantsolutionsConfig",
    axisbank: "AxisbankConfig",
    easebuzz: "EasebuzzConfig",
    twocTwopPaco: "TwocTwopPacoConfig",
    bamboraapac: "BamboraapacConfig",
    placetopay: "PlacetopayConfig",
    finix: "FinixConfig",
    aci: "AciConfig",
    interpayments: "InterpaymentsConfig",
  },
  PaymentServiceTokenAuthorizeRequest: {
    amount: "Money",
    customer: "Customer",
  ...
  PayoutMethod: {
    card: "CardPayout",
    ach: "AchBankTransferPayout",
    bacs: "BacsBankTransferPayout",
    sepa: "SepaBankTransferPayout",
    pix: "PixBankTransferPayout",
    applePayDecrypt: "ApplePayDecrypt",
    paypal: "Paypal",
    venmo: "Venmo",
    interac: "InteracPayout",
    openBankingUk: "OpenBankingUkPayout",
    passthrough: "Passthrough",
    pixKey: "PixKeyBankTransferPayout",
    pixEmv: "PixEmvBankTransferPayout",
  },
  SourceBankData: {
    ach: "AchBankTransferPayout",
    bacs: "BacsBankTransferPayout",
  ...
  PayoutServiceCreateRequest: {
    ...
    payoutMethodData: "PayoutMethod",
    amount: "Money",
    customer: "Customer",
    browserInfo: "BrowserInformation",
    sourceBankData: "SourceBankData",
  },
  ...
  ConnectorConfig: {
    connectorConfig: "ConnectorSpecificConfig",
    options: "SdkOptions",
  },
  ...
  FfiResult: {
    httpRequest: "FfiConnectorHttpRequest",
    httpResponse: "FfiConnectorHttpResponse",
...
function _wrapSecretStrings(obj: unknown, msgName: string): unknown {
  ...
  if (Array.isArray(obj))
    return (obj as unknown[]).map((item) => _wrapSecretStrings(item, msgName));
...
function callGrpc(
  ...
  const reqBuf = Buffer.from(
    ReqType.encode(ReqType.create(normalized)).finish(),
  );
  const outLen = [0];
  ...
  if (rawBytes[0] === 1) {
    throw new Error(
      `gRPC error (${method}): ${rawBytes.slice(1).toString("utf-8")}`,
    );
  }
...
export class GrpcCustomerClient {
  ...
  async create(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "customer/create",
      req,
      types.CustomerServiceCreateRequest,
      types.CustomerServiceCreateResponse,
    );
  }
}
...
export class GrpcDisputeClient {
  ...
  async submitEvidence(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.DisputeServiceSubmitEvidenceRequest,
      types.DisputeServiceSubmitEvidenceResponse,
    );
  }
  ...
  async disputeGet(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "dispute/dispute_get",
      req,
      types.DisputeServiceGetRequest,
      types.DisputeResponse,
    );
  }
  ...
  async defend(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "dispute/defend",
      req,
      types.DisputeServiceDefendRequest,
      types.DisputeServiceDefendResponse,
    );
  }
  ...
  async accept(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "dispute/accept",
      req,
      types.DisputeServiceAcceptRequest,
      types.DisputeServiceAcceptResponse,
    );
  }
}
...
export class GrpcEventClient {
  ...
  async parseEvent(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "event/parse_event",
      req,
      types.EventServiceParseRequest,
      types.EventServiceParseResponse,
    );
  }
  ...
  async handleEvent(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "event/handle_event",
      req,
      types.EventServiceHandleRequest,
      types.EventServiceHandleResponse,
    );
  }
  ...
  async NotifyConnector(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.NotifyConnectorRequest,
      types.NotifyConnectorResponse,
    );
  }
}
...
export class GrpcMerchantAuthenticationClient {
  ...
  async createServerAuthenticationToken(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.MerchantAuthenticationServiceCreateServerAuthenticationTokenRequest,
      types.MerchantAuthenticationServiceCreateServerAuthenticationTokenResponse,
    );
  }
  ...
  async createServerSessionAuthenticationToken(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.MerchantAuthenticationServiceCreateServerSessionAuthenticationTokenRequest,
      types.MerchantAuthenticationServiceCreateServerSessionAuthenticationTokenResponse,
    );
  }
  ...
  async createClientAuthenticationToken(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.MerchantAuthenticationServiceCreateClientAuthenticationTokenRequest,
      types.MerchantAuthenticationServiceCreateClientAuthenticationTokenResponse,
    );
  }
}
...
export class GrpcPaymentMethodAuthenticationClient {
  ...
  async preAuthenticate(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentMethodAuthenticationServicePreAuthenticateRequest,
      types.PaymentMethodAuthenticationServicePreAuthenticateResponse,
    );
  }
  ...
  async authenticate(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentMethodAuthenticationServiceAuthenticateRequest,
      types.PaymentMethodAuthenticationServiceAuthenticateResponse,
    );
  }
  ...
  async postAuthenticate(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentMethodAuthenticationServicePostAuthenticateRequest,
      types.PaymentMethodAuthenticationServicePostAuthenticateResponse,
    );
  }
}
...
export class GrpcPaymentMethodClient {
  ...
  async tokenize(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentMethodServiceTokenizeRequest,
      types.PaymentMethodServiceTokenizeResponse,
    );
  }
  ...
  async eligibility(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PayoutMethodEligibilityRequest,
      types.PayoutMethodEligibilityResponse,
    );
  }
}
...
export class GrpcPaymentClient {
  ...
  async authorize(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payment/authorize",
      req,
      types.PaymentServiceAuthorizeRequest,
      types.PaymentServiceAuthorizeResponse,
    );
  }
  ...
  async get(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payment/get",
      req,
      types.PaymentServiceGetRequest,
      types.PaymentServiceGetResponse,
    );
  }
  ...
  async void(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payment/void",
      req,
      types.PaymentServiceVoidRequest,
      types.PaymentServiceVoidResponse,
    );
  }
  ...
  async reverse(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payment/reverse",
      req,
      types.PaymentServiceReverseRequest,
      types.PaymentServiceReverseResponse,
    );
  }
  ...
  async capture(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payment/capture",
      req,
      types.PaymentServiceCaptureRequest,
      types.PaymentServiceCaptureResponse,
    );
  }
  ...
  async createOrder(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentServiceCreateOrderRequest,
      types.PaymentServiceCreateOrderResponse,
    );
  }
  ...
  async refund(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payment/refund",
      req,
      types.PaymentServiceRefundRequest,
      types.RefundResponse,
    );
  }
  ...
  async incrementalAuthorization(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentServiceIncrementalAuthorizationRequest,
      types.PaymentServiceIncrementalAuthorizationResponse,
    );
  }
  ...
  async verifyRedirectResponse(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentServiceVerifyRedirectResponseRequest,
      types.PaymentServiceVerifyRedirectResponseResponse,
    );
  }
  ...
  async setupRecurring(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentServiceSetupRecurringRequest,
      types.PaymentServiceSetupRecurringResponse,
    );
  }
  ...
  async tokenSetupRecurring(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentServiceTokenSetupRecurringRequest,
      types.PaymentServiceSetupRecurringResponse,
    );
  }
  ...
  async proxyAuthorize(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentServiceProxyAuthorizeRequest,
      types.PaymentServiceAuthorizeResponse,
    );
  }
  ...
  async proxySetupRecurring(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PaymentServiceProxySetupRecurringRequest,
      types.PaymentServiceSetupRecurringResponse,
    );
  }
}
...
export class GrpcPayoutClient {
  ...
  async payoutCreate(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PayoutServiceCreateRequest,
      types.PayoutServiceCreateResponse,
    );
  }
  ...
  async transfer(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payout/transfer",
      req,
      types.PayoutServiceTransferRequest,
      types.PayoutServiceTransferResponse,
    );
  }
  ...
  async payoutGet(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payout/payout_get",
      req,
      types.PayoutServiceGetRequest,
      types.PayoutServiceGetResponse,
    );
  }
  ...
  async payoutVoid(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payout/payout_void",
      req,
      types.PayoutServiceVoidRequest,
      types.PayoutServiceVoidResponse,
    );
  }
  ...
  async stage(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payout/stage",
      req,
      types.PayoutServiceStageRequest,
      types.PayoutServiceStageResponse,
    );
  }
  ...
  async createLink(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "payout/create_link",
      req,
      types.PayoutServiceCreateLinkRequest,
      types.PayoutServiceCreateLinkResponse,
    );
  }
  ...
  async createRecipient(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PayoutServiceCreateRecipientRequest,
      types.PayoutServiceCreateRecipientResponse,
    );
  }
  ...
  async enrollDisburseAccount(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.PayoutServiceEnrollDisburseAccountRequest,
      types.PayoutServiceEnrollDisburseAccountResponse,
    );
  }
}
...
export class GrpcRecurringPaymentClient {
  ...
  async charge(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.RecurringPaymentServiceChargeRequest,
      types.RecurringPaymentServiceChargeResponse,
    );
  }
  ...
  async revoke(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      req,
      types.RecurringPaymentServiceRevokeRequest,
      types.RecurringPaymentServiceRevokeResponse,
    );
  }
}
...
export class GrpcSurchargeClient {
  ...
  async calculate(req: unknown): Promise<unknown> {
    return callGrpc(
      ...
      "surcharge/calculate",
      req,
      types.SurchargeServiceCalculateRequest,
      types.SurchargeServiceCalculateResponse,
    );
  }
}
...
export class GrpcClient {
  ...
  constructor(config: GrpcConfig, libPath?: string) {
    ...
    this.merchantAuthentication = new GrpcMerchantAuthenticationClient(
      ffi,
      config,
    );
    this.paymentMethodAuthentication =
      new GrpcPaymentMethodAuthenticationClient(ffi, config);
