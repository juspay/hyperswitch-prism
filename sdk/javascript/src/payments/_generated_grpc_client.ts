...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  PaymentServiceRefundRequest: { "refundAmount": "Money", "browserInfo": "BrowserInformation", "state": "ConnectorState", "paymentMethod": "PaymentMethod", "splitRefunds": "RefundSplitRequest" },
  RefundSplitRequest: { "adyenSplitRefund": "AdyenSplitRefund" },
  AdyenSplitRefund: { "splitItems": "AdyenRefundSplitItem" },
