...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  EftBankTransferPayout: ["bankAccountNumber", "branchCode", "bankAccountHolderName"],
  ...
  PayoutServiceTransferRequest: ["accessToken", "metadata"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  PayoutMethod: { "card": "CardPayout", "ach": "AchBankTransferPayout", "bacs": "BacsBankTransferPayout", "sepa": "SepaBankTransferPayout", "pix": "PixBankTransferPayout", "applePayDecrypt": "ApplePayDecrypt", "paypal": "Paypal", "venmo": "Venmo", "interac": "InteracPayout", "openBankingUk": "OpenBankingUkPayout", "passthrough": "Passthrough", "pixKey": "PixKeyBankTransferPayout", "pixEmv": "PixEmvBankTransferPayout", "eft": "EftBankTransferPayout" },
