...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  CompositeFrmDeviceDataCollectionRequest: ["metadata", "connectorFeatureData"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  CompositeFrmDeviceDataCollectionRequest: { "amount": "Money", "paymentMethod": "PaymentMethod", "customer": "Customer", "address": "PaymentAddress", "browserInfo": "BrowserInformation", "state": "ConnectorState" },
  ...
  CompositeFrmDeviceDataCollectionResponse: { "deviceDataCollectionResponse": "PaymentMethodAuthenticationServicePreAuthenticateResponse", "accessTokenResponse": "MerchantAuthenticationServiceCreateServerAuthenticationTokenResponse" },
