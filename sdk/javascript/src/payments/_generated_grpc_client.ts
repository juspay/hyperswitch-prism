...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  PaymentServiceVerifyRedirectResponseResponse: ["rawConnectorResponse", "typedConnectorResponse"],
