...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  StoredCardForNetworkTransactionId: ["cardNumber", "cardExpMonth", "cardExpYear", "nickName", "cardHolderName", "networkTransactionId"],
