...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  VendorDetails: ["businessProfileUrl", "businessProfileName", "statementDescriptor"],
  IndividualDetails: ["firstName", "lastName", "phone", "ssnLast_4", "idNumber", "dobDay", "dobMonth", "dobYear", "tosAcceptanceIp"],
