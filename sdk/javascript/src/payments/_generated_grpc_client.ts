...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  PaymentServiceAuthorizeRequest: ["metadata", "connectorFeatureData", "AdditionalConnectorDetails"],
  ...
  PaymentServiceCaptureRequest: ["metadata", "connectorFeatureData", "AdditionalConnectorDetails"],
  ...
  RecurringPaymentServiceChargeRequest: ["metadata", "connectorFeatureData", "email", "merchantAccountId", "connectorTestingData", "AdditionalConnectorDetails"],
